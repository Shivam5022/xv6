...
80100048:	bb d4 cf 10 80       	mov    $0x8010cfd4,%ebx
{
8010004d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
80100050:	68 20 7f 10 80       	push   $0x80107f20
80100055:	68 a0 cf 10 80       	push   $0x8010cfa0
8010005a:	e8 e1 49 00 00       	call   80104a40 <initlock>
  bcache.head.next = &bcache.head;
8010005f:	83 c4 10             	add    $0x10,%esp
80100062:	b8 9c 16 11 80       	mov    $0x8011169c,%eax
  bcache.head.prev = &bcache.head;
80100067:	c7 05 ec 16 11 80 9c 	movl   $0x8011169c,0x801116ec
8010006e:	16 11 80 
  bcache.head.next = &bcache.head;
80100071:	c7 05 f0 16 11 80 9c 	movl   $0x8011169c,0x801116f0
80100078:	16 11 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
...
801000b0:	89 1d f0 16 11 80    	mov    %ebx,0x801116f0
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	81 fb 40 14 11 80    	cmp    $0x80111440,%ebx
...
801000e0:	8b 75 0c             	mov    0xc(%ebp),%esi
  acquire(&bcache.lock);
801000e3:	68 a0 cf 10 80       	push   $0x8010cfa0
801000e8:	e8 d3 4a 00 00       	call   80104bc0 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000ed:	8b 1d f0 16 11 80    	mov    0x801116f0,%ebx
801000f3:	83 c4 10             	add    $0x10,%esp
801000f6:	81 fb 9c 16 11 80    	cmp    $0x8011169c,%ebx
...
801001a3:	68 2e 7f 10 80       	push   $0x80107f2e
...
801001e0:	68 3f 7f 10 80       	push   $0x80107f3f
...
80100213:	e8 88 47 00 00       	call   801049a0 <releasesleep>
  ...
  acquire(&bcache.lock);
80100218:	c7 04 24 a0 cf 10 80 	movl   $0x8010cfa0,(%esp)
...
80100243:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100246:	a1 f0 16 11 80       	mov    0x801116f0,%eax
    b->prev = &bcache.head;
8010024b:	c7 43 50 9c 16 11 80 	movl   $0x8011169c,0x50(%ebx)
    b->next = bcache.head.next;
80100252:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100255:	a1 f0 16 11 80       	mov    0x801116f0,%eax
8010025a:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
8010025d:	89 1d f0 16 11 80    	mov    %ebx,0x801116f0
  }
  
  release(&bcache.lock);
80100263:	c7 45 08 a0 cf 10 80 	movl   $0x8010cfa0,0x8(%ebp)
}
...
80100278:	68 46 7f 10 80       	push   $0x80107f46
...
801002a5:	e8 96 15 00 00       	call   80101840 <iunlock>
  acquire(&cons.lock);
801002aa:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
...
801002c6:	a1 80 19 11 80       	mov    0x80111980,%eax
801002cb:	3b 05 84 19 11 80    	cmp    0x80111984,%eax
801002d1:	74 27                	je     801002fa <consoleread+0x6a>
801002d3:	eb 5b                	jmp    80100330 <consoleread+0xa0>
801002d5:	8d 76 00             	lea    0x0(%esi),%esi
      sleep(&input.r, &cons.lock);
801002d8:	83 ec 08             	sub    $0x8,%esp
801002db:	68 c0 b5 10 80       	push   $0x8010b5c0
801002e0:	68 80 19 11 80       	push   $0x80111980
801002e5:	e8 16 3e 00 00       	call   80104100 <sleep>
    while(input.r == input.w){
801002ea:	a1 80 19 11 80       	mov    0x80111980,%eax
801002ef:	83 c4 10             	add    $0x10,%esp
801002f2:	3b 05 84 19 11 80    	cmp    0x80111984,%eax
...
80100309:	68 c0 b5 10 80       	push   $0x8010b5c0
...
80100333:	89 15 80 19 11 80    	mov    %edx,0x80111980
80100339:	89 c2                	mov    %eax,%edx
8010033b:	83 e2 7f             	and    $0x7f,%edx
8010033e:	0f be 8a 00 19 11 80 	movsbl -0x7feee700(%edx),%ecx
    if(c == C('D')){  // EOF
...
80100360:	68 c0 b5 10 80       	push   $0x8010b5c0
...
80100384:	73 d7                	jae    8010035d <consoleread+0xcd>
        input.r--;
80100386:	a3 80 19 11 80       	mov    %eax,0x80111980
...
8010039c:	fa                   	cli    
  cons.locking = 0;
8010039d:	c7 05 f4 b5 10 80 00 	movl   $0x0,0x8010b5f4
801003a4:	00 00 00 
  getcallerpcs(&s, pcs);
...
801003b6:	68 4d 7f 10 80       	push   $0x80107f4d
...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 36 85 10 80 	movl   $0x80108536,(%esp)
...
801003dc:	e8 7f 46 00 00       	call   80104a60 <getcallerpcs>
  for(i=0; i<10; i++)
...
801003ec:	68 61 7f 10 80       	push   $0x80107f61
...
801003fd:	c7 05 f8 b5 10 80 01 	movl   $0x1,0x8010b5f8
80100404:	00 00 00 
  for(;;)
...
80100561:	e8 0a 48 00 00       	call   80104d70 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100576:	e8 55 47 00 00       	call   80104cd0 <memset>
8010057b:	88 5d e7             	mov    %bl,-0x19(%ebp)
8010057e:	83 c4 10             	add    $0x10,%esp
80100581:	e9 22 ff ff ff       	jmp    801004a8 <consputc.part.0+0x98>
    panic("pos under/overflow");
80100586:	83 ec 0c             	sub    $0xc,%esp
80100589:	68 65 7f 10 80       	push   $0x80107f65
...
801005c9:	0f b6 92 90 7f 10 80 	movzbl -0x7fef8070(%edx),%edx
...
80100600:	0f be c2             	movsbl %dl,%eax
  if(panicked){
80100603:	8b 15 f8 b5 10 80    	mov    0x8010b5f8,%edx
...
80100653:	e8 e8 11 00 00       	call   80101840 <iunlock>
  acquire(&cons.lock);
80100658:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
8010065f:	e8 5c 45 00 00       	call   80104bc0 <acquire>
  for(i = 0; i < n; i++)
...
8010066e:	8d 34 1f             	lea    (%edi,%ebx,1),%esi
  if(panicked){
80100671:	8b 15 f8 b5 10 80    	mov    0x8010b5f8,%edx
...
80100692:	68 c0 b5 10 80       	push   $0x8010b5c0
80100697:	e8 e4 45 00 00       	call   80104c80 <release>
  ilock(ip);
8010069c:	58                   	pop    %eax
...
801006bd:	a1 f4 b5 10 80       	mov    0x8010b5f4,%eax
...
801006ea:	74 44                	je     80100730 <cprintf+0x80>
  if(panicked){
801006ec:	8b 0d f8 b5 10 80    	mov    0x8010b5f8,%ecx
...
8010077b:	75 55                	jne    801007d2 <cprintf+0x122>
        s = "(null)";
8010077d:	bb 78 7f 10 80       	mov    $0x80107f78,%ebx
      for(; *s; s++)
80100782:	b8 28 00 00 00       	mov    $0x28,%eax
  if(panicked){
80100787:	8b 15 f8 b5 10 80    	mov    0x8010b5f8,%edx
...
801007b8:	68 c0 b5 10 80       	push   $0x8010b5c0
801007bd:	e8 fe 43 00 00       	call   80104bc0 <acquire>
...
801007db:	e9 2a ff ff ff       	jmp    8010070a <cprintf+0x5a>
  if(panicked){
801007e0:	8b 3d f8 b5 10 80    	mov    0x8010b5f8,%edi
...
801007f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(panicked){
801007f8:	8b 0d f8 b5 10 80    	mov    0x8010b5f8,%ecx
...
8010080d:	e8 fe fb ff ff       	call   80100410 <consputc.part.0>
  if(panicked){
80100812:	8b 15 f8 b5 10 80    	mov    0x8010b5f8,%edx
...
80100823:	68 c0 b5 10 80       	push   $0x8010b5c0
80100828:	e8 53 44 00 00       	call   80104c80 <release>
8010082d:	83 c4 10             	add    $0x10,%esp
}
80100830:	e9 ee fe ff ff       	jmp    80100723 <cprintf+0x73>
    panic("null fmt");
80100835:	83 ec 0c             	sub    $0xc,%esp
80100838:	68 7f 7f 10 80       	push   $0x80107f7f
...
8010086f:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&cons.lock);
80100872:	68 c0 b5 10 80       	push   $0x8010b5c0
80100877:	e8 44 43 00 00       	call   80104bc0 <acquire>
  while((c = getc()) >= 0){
...
801008b4:	a1 88 19 11 80       	mov    0x80111988,%eax
801008b9:	89 c2                	mov    %eax,%edx
801008bb:	2b 15 80 19 11 80    	sub    0x80111980,%edx
801008c1:	83 fa 7f             	cmp    $0x7f,%edx
801008c4:	77 d2                	ja     80100898 <consoleintr+0x38>
        c = (c == '\r') ? '\n' : c;
801008c6:	8d 48 01             	lea    0x1(%eax),%ecx
801008c9:	8b 15 f8 b5 10 80    	mov    0x8010b5f8,%edx
801008cf:	83 e0 7f             	and    $0x7f,%eax
        input.buf[input.e++ % INPUT_BUF] = c;
801008d2:	89 0d 88 19 11 80    	mov    %ecx,0x80111988
        c = (c == '\r') ? '\n' : c;
801008d8:	83 fb 0d             	cmp    $0xd,%ebx
801008db:	0f 84 02 01 00 00    	je     801009e3 <consoleintr+0x183>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e1:	88 98 00 19 11 80    	mov    %bl,-0x7feee700(%eax)
  if(panicked){
...
80100908:	a1 80 19 11 80       	mov    0x80111980,%eax
8010090d:	83 e8 80             	sub    $0xffffff80,%eax
80100910:	39 05 88 19 11 80    	cmp    %eax,0x80111988
80100916:	75 80                	jne    80100898 <consoleintr+0x38>
80100918:	e9 f6 00 00 00       	jmp    80100a13 <consoleintr+0x1b3>
8010091d:	8d 76 00             	lea    0x0(%esi),%esi
      while(input.e != input.w &&
80100920:	a1 88 19 11 80       	mov    0x80111988,%eax
80100925:	39 05 84 19 11 80    	cmp    %eax,0x80111984
...
80100936:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100939:	80 ba 00 19 11 80 0a 	cmpb   $0xa,-0x7feee700(%edx)
80100940:	0f 84 52 ff ff ff    	je     80100898 <consoleintr+0x38>
  if(panicked){
80100946:	8b 15 f8 b5 10 80    	mov    0x8010b5f8,%edx
        input.e--;
8010094c:	a3 88 19 11 80       	mov    %eax,0x80111988
  if(panicked){
...
80100965:	e8 a6 fa ff ff       	call   80100410 <consputc.part.0>
      while(input.e != input.w &&
8010096a:	a1 88 19 11 80       	mov    0x80111988,%eax
8010096f:	3b 05 84 19 11 80    	cmp    0x80111984,%eax
80100975:	75 ba                	jne    80100931 <consoleintr+0xd1>
80100977:	e9 1c ff ff ff       	jmp    80100898 <consoleintr+0x38>
8010097c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(input.e != input.w){
80100980:	a1 88 19 11 80       	mov    0x80111988,%eax
80100985:	3b 05 84 19 11 80    	cmp    0x80111984,%eax
8010098b:	0f 84 07 ff ff ff    	je     80100898 <consoleintr+0x38>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 88 19 11 80       	mov    %eax,0x80111988
  if(panicked){
80100999:	a1 f8 b5 10 80       	mov    0x8010b5f8,%eax
...
801009ca:	68 c0 b5 10 80       	push   $0x8010b5c0
801009cf:	e8 ac 42 00 00       	call   80104c80 <release>
  if(doprocdump) {
...
801009e2:	c3                   	ret    
        input.buf[input.e++ % INPUT_BUF] = c;
801009e3:	c6 80 00 19 11 80 0a 	movb   $0xa,-0x7feee700(%eax)
  if(panicked){
...
80100a09:	e8 02 fa ff ff       	call   80100410 <consputc.part.0>
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
80100a0e:	a1 88 19 11 80       	mov    0x80111988,%eax
          wakeup(&input.r);
80100a13:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a16:	a3 84 19 11 80       	mov    %eax,0x80111984
          wakeup(&input.r);
80100a1b:	68 80 19 11 80       	push   $0x80111980
80100a20:	e8 9b 38 00 00       	call   801042c0 <wakeup>
...
80100a3a:	68 88 7f 10 80       	push   $0x80107f88
80100a3f:	68 c0 b5 10 80       	push   $0x8010b5c0
80100a44:	e8 f7 3f 00 00       	call   80104a40 <initlock>
...
80100a4d:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a4f:	c7 05 4c 23 11 80 40 	movl   $0x80100640,0x8011234c
80100a56:	06 10 80 
  devsw[CONSOLE].read = consoleread;
80100a59:	c7 05 48 23 11 80 90 	movl   $0x80100290,0x80112348
80100a60:	02 10 80 
  cons.locking = 1;
80100a63:	c7 05 f4 b5 10 80 01 	movl   $0x1,0x8010b5f4
80100a6a:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
...
80100ca3:	e8 28 42 00 00       	call   80104ed0 <strlen>
...
80100cb6:	e8 15 42 00 00       	call   80104ed0 <strlen>
...
80100d71:	e8 1a 41 00 00       	call   80104e90 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100dbc:	68 a1 7f 10 80       	push   $0x80107fa1
...
80100dea:	68 ad 7f 10 80       	push   $0x80107fad
80100def:	68 a0 19 11 80       	push   $0x801119a0
80100df4:	e8 47 3c 00 00       	call   80104a40 <initlock>
}
...
80100e08:	bb d4 19 11 80       	mov    $0x801119d4,%ebx
{
80100e0d:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e10:	68 a0 19 11 80       	push   $0x801119a0
80100e15:	e8 a6 3d 00 00       	call   80104bc0 <acquire>
80100e1a:	83 c4 10             	add    $0x10,%esp
80100e1d:	eb 0c                	jmp    80100e2b <filealloc+0x2b>
80100e1f:	90                   	nop
  for(f = ftable.file; f < ftable.file + NFILE; f++){
80100e20:	83 c3 18             	add    $0x18,%ebx
80100e23:	81 fb 34 23 11 80    	cmp    $0x80112334,%ebx
...
80100e41:	e8 3a 3e 00 00       	call   80104c80 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e53:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e55:	68 a0 19 11 80       	push   $0x801119a0
80100e5a:	e8 21 3e 00 00       	call   80104c80 <release>
}
...
80100e7b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100e7e:	68 a0 19 11 80       	push   $0x801119a0
80100e83:	e8 38 3d 00 00       	call   80104bc0 <acquire>
  if(f->ref < 1)
...
80100e98:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e9b:	68 a0 19 11 80       	push   $0x801119a0
80100ea0:	e8 db 3d 00 00       	call   80104c80 <release>
  return f;
}
...
80100eaf:	68 b4 7f 10 80       	push   $0x80107fb4
...
80100ecd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100ed0:	68 a0 19 11 80       	push   $0x801119a0
80100ed5:	e8 e6 3c 00 00       	call   80104bc0 <acquire>
  if(f->ref < 1)
...
80100f05:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f08:	68 a0 19 11 80       	push   $0x801119a0
  ff = *f;
80100f0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f10:	e8 6b 3d 00 00       	call   80104c80 <release>
...
80100f2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f30:	c7 45 08 a0 19 11 80 	movl   $0x801119a0,0x8(%ebp)
}
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 3d 3d 00 00       	jmp    80104c80 <release>
...
80100f8c:	68 bc 7f 10 80       	push   $0x80107fbc
...
8010107a:	68 c6 7f 10 80       	push   $0x80107fc6
...
80101163:	68 cf 7f 10 80       	push   $0x80107fcf
...
80101199:	68 d5 7f 10 80       	push   $0x80107fd5
...
801011b8:	03 05 b8 23 11 80    	add    0x801123b8,%eax
{
...
80101217:	68 df 7f 10 80       	push   $0x80107fdf
...
80101239:	8b 0d a0 23 11 80    	mov    0x801123a0,%ecx
{
...
8010125c:	03 05 b8 23 11 80    	add    0x801123b8,%eax
...
80101271:	a1 a0 23 11 80       	mov    0x801123a0,%eax
...
801012c9:	39 05 a0 23 11 80    	cmp    %eax,0x801123a0
801012cf:	77 80                	ja     80101251 <balloc+0x21>
  panic("balloc: out of blocks");
801012d1:	83 ec 0c             	sub    $0xc,%esp
801012d4:	68 f2 7f 10 80       	push   $0x80107ff2
...
80101315:	e8 b6 39 00 00       	call   80104cd0 <memset>
  log_write(bp);
...
8010134a:	bb f4 23 11 80       	mov    $0x801123f4,%ebx
{
8010134f:	83 ec 28             	sub    $0x28,%esp
80101352:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101355:	68 c0 23 11 80       	push   $0x801123c0
8010135a:	e8 61 38 00 00       	call   80104bc0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101374:	81 c3 90 00 00 00    	add    $0x90,%ebx
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010137a:	81 fb 14 40 11 80    	cmp    $0x80114014,%ebx
...
80101399:	89 c6                	mov    %eax,%esi
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010139b:	81 fb 14 40 11 80    	cmp    $0x80114014,%ebx
...
801013bb:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801013c2:	68 c0 23 11 80       	push   $0x801123c0
801013c7:	e8 b4 38 00 00       	call   80104c80 <release>
...
801013eb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013ed:	68 c0 23 11 80       	push   $0x801123c0
      ip->ref++;
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 86 38 00 00       	call   80104c80 <release>
      return ip;
...
80101406:	c3                   	ret    
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101407:	81 fb 14 40 11 80    	cmp    $0x80114014,%ebx
...
80101422:	68 08 80 10 80       	push   $0x80108008
...
801014eb:	68 18 80 10 80       	push   $0x80108018
...
80101525:	e8 46 38 00 00       	call   80104d70 <memmove>
  brelse(bp);
...
80101548:	bb 00 24 11 80       	mov    $0x80112400,%ebx
8010154d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
80101550:	68 2b 80 10 80       	push   $0x8010802b
80101555:	68 c0 23 11 80       	push   $0x801123c0
8010155a:	e8 e1 34 00 00       	call   80104a40 <initlock>
  for(i = 0; i < NINODE; i++) {
8010155f:	83 c4 10             	add    $0x10,%esp
80101562:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    initsleeplock(&icache.inode[i].lock, "inode");
80101568:	83 ec 08             	sub    $0x8,%esp
8010156b:	68 32 80 10 80       	push   $0x80108032
80101570:	53                   	push   %ebx
80101571:	81 c3 90 00 00 00    	add    $0x90,%ebx
80101577:	e8 84 33 00 00       	call   80104900 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
8010157c:	83 c4 10             	add    $0x10,%esp
8010157f:	81 fb 20 40 11 80    	cmp    $0x80114020,%ebx
80101585:	75 e1                	jne    80101568 <iinit+0x28>
  readsb(dev, &sb);
80101587:	83 ec 08             	sub    $0x8,%esp
8010158a:	68 a0 23 11 80       	push   $0x801123a0
8010158f:	ff 75 08             	pushl  0x8(%ebp)
80101592:	e8 69 ff ff ff       	call   80101500 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
80101597:	ff 35 b8 23 11 80    	pushl  0x801123b8
8010159d:	ff 35 b4 23 11 80    	pushl  0x801123b4
801015a3:	ff 35 b0 23 11 80    	pushl  0x801123b0
801015a9:	ff 35 ac 23 11 80    	pushl  0x801123ac
801015af:	ff 35 a8 23 11 80    	pushl  0x801123a8
801015b5:	ff 35 a4 23 11 80    	pushl  0x801123a4
801015bb:	ff 35 a0 23 11 80    	pushl  0x801123a0
801015c1:	68 98 80 10 80       	push   $0x80108098
...
801015f0:	83 3d a8 23 11 80 01 	cmpl   $0x1,0x801123a8
{
...
8010161f:	3b 3d a8 23 11 80    	cmp    0x801123a8,%edi
80101625:	73 69                	jae    80101690 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101627:	89 f8                	mov    %edi,%eax
80101629:	83 ec 08             	sub    $0x8,%esp
8010162c:	c1 e8 03             	shr    $0x3,%eax
8010162f:	03 05 b4 23 11 80    	add    0x801123b4,%eax
...
8010165e:	e8 6d 36 00 00       	call   80104cd0 <memset>
      dip->type = type;
...
80101693:	68 38 80 10 80       	push   $0x80108038
...
801016b8:	03 05 b4 23 11 80    	add    0x801123b4,%eax
...
80101705:	e8 66 36 00 00       	call   80104d70 <memmove>
  log_write(bp);
...
8010173b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010173e:	68 c0 23 11 80       	push   $0x801123c0
80101743:	e8 78 34 00 00       	call   80104bc0 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 c0 23 11 80 	movl   $0x801123c0,(%esp)
80101753:	e8 28 35 00 00       	call   80104c80 <release>
}
...
80101786:	e8 b5 31 00 00       	call   80104940 <acquiresleep>
  if(ip->valid == 0){
...
801017a9:	03 05 b4 23 11 80    	add    0x801123b4,%eax
...
801017f8:	e8 73 35 00 00       	call   80104d70 <memmove>
    brelse(bp);
...
8010181d:	68 50 80 10 80       	push   $0x80108050
80101822:	e8 69 eb ff ff       	call   80100390 <panic>
    panic("ilock");
80101827:	83 ec 0c             	sub    $0xc,%esp
8010182a:	68 4a 80 10 80       	push   $0x8010804a
...
80101857:	e8 84 31 00 00       	call   801049e0 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 28 31 00 00       	jmp    801049a0 <releasesleep>
    panic("iunlock");
80101878:	83 ec 0c             	sub    $0xc,%esp
8010187b:	68 5f 80 10 80       	push   $0x8010805f
...
801018a4:	e8 97 30 00 00       	call   80104940 <acquiresleep>
...
801018be:	e8 dd 30 00 00       	call   801049a0 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 c0 23 11 80 	movl   $0x801123c0,(%esp)
801018ca:	e8 f1 32 00 00       	call   80104bc0 <acquire>
  ip->ref--;
801018cf:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018d3:	83 c4 10             	add    $0x10,%esp
801018d6:	c7 45 08 c0 23 11 80 	movl   $0x801123c0,0x8(%ebp)
}
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 97 33 00 00       	jmp    80104c80 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 c0 23 11 80       	push   $0x801123c0
801018f8:	e8 c3 32 00 00       	call   80104bc0 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 c0 23 11 80 	movl   $0x801123c0,(%esp)
80101907:	e8 74 33 00 00       	call   80104c80 <release>
    if(r == 1){
...
80101b07:	e8 64 32 00 00       	call   80104d70 <memmove>
    brelse(bp);
...
80101b3a:	8b 04 c5 40 23 11 80 	mov    -0x7feedcc0(,%eax,8),%eax
...
80101c03:	e8 68 31 00 00       	call   80104d70 <memmove>
    log_write(bp);
...
80101c4a:	8b 04 c5 44 23 11 80 	mov    -0x7feedcbc(,%eax,8),%eax
...
80101ca2:	e8 39 31 00 00       	call   80104de0 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 d6 30 00 00       	call   80104de0 <strncmp>
      continue;
...
80101d4a:	68 79 80 10 80       	push   $0x80108079
80101d4f:	e8 3c e6 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101d54:	83 ec 0c             	sub    $0xc,%esp
80101d57:	68 67 80 10 80       	push   $0x80108067
...
80101d94:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101d97:	68 c0 23 11 80       	push   $0x801123c0
80101d9c:	e8 1f 2e 00 00       	call   80104bc0 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 c0 23 11 80 	movl   $0x801123c0,(%esp)
80101dac:	e8 cf 2e 00 00       	call   80104c80 <release>
...
80101e17:	e8 54 2f 00 00       	call   80104d70 <memmove>
...
80101ea3:	e8 c8 2e 00 00       	call   80104d70 <memmove>
    name[len] = 0;
...
80101fd5:	e8 56 2e 00 00       	call   80104e30 <strncpy>
...
80102013:	68 88 80 10 80       	push   $0x80108088
80102018:	e8 73 e3 ff ff       	call   80100390 <panic>
    panic("dirlink");
8010201d:	83 ec 0c             	sub    $0xc,%esp
80102020:	68 d2 86 10 80       	push   $0x801086d2
...
8010212b:	68 f4 80 10 80       	push   $0x801080f4
80102130:	e8 5b e2 ff ff       	call   80100390 <panic>
    panic("idestart");
80102135:	83 ec 0c             	sub    $0xc,%esp
80102138:	68 eb 80 10 80       	push   $0x801080eb
...
8010215a:	68 06 81 10 80       	push   $0x80108106
8010215f:	68 20 b6 10 80       	push   $0x8010b620
80102164:	e8 d7 28 00 00       	call   80104a40 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102169:	58                   	pop    %eax
8010216a:	a1 e0 46 11 80       	mov    0x801146e0,%eax
8010216f:	5a                   	pop    %edx
...
801021b8:	74 f6                	je     801021b0 <ideinit+0x60>
      havedisk1 = 1;
801021ba:	c7 05 00 b6 10 80 01 	movl   $0x1,0x8010b600
801021c1:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
801021ea:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
801021ed:	68 20 b6 10 80       	push   $0x8010b620
801021f2:	e8 c9 29 00 00       	call   80104bc0 <acquire>

  if((b = idequeue) == 0){
801021f7:	8b 1d 04 b6 10 80    	mov    0x8010b604,%ebx
...
80102207:	a3 04 b6 10 80       	mov    %eax,0x8010b604
...
8010224d:	e8 6e 20 00 00       	call   801042c0 <wakeup>

  // Start disk on next buf in queue.
  if(idequeue != 0)
80102252:	a1 04 b6 10 80       	mov    0x8010b604,%eax
...
80102266:	68 20 b6 10 80       	push   $0x8010b620
8010226b:	e8 10 2a 00 00       	call   80104c80 <release>
...
80102292:	e8 49 27 00 00       	call   801049e0 <holdingsleep>
...
801022b7:	a1 00 b6 10 80       	mov    0x8010b600,%eax
...
801022c7:	68 20 b6 10 80       	push   $0x8010b620
801022cc:	e8 ef 28 00 00       	call   80104bc0 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
801022d1:	a1 04 b6 10 80       	mov    0x8010b604,%eax
  b->qnext = 0;
...
801022f4:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
801022f6:	39 1d 04 b6 10 80    	cmp    %ebx,0x8010b604
...
80102313:	68 20 b6 10 80       	push   $0x8010b620
80102318:	53                   	push   %ebx
80102319:	e8 e2 1d 00 00       	call   80104100 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102329:	75 e5                	jne    80102310 <iderw+0x90>
  ...
  release(&idelock);
8010232b:	c7 45 08 20 b6 10 80 	movl   $0x8010b620,0x8(%ebp)
}
80102332:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 45 29 00 00       	jmp    80104c80 <release>
...
80102349:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
80102350:	ba 04 b6 10 80       	mov    $0x8010b604,%edx
80102355:	eb 9d                	jmp    801022f4 <iderw+0x74>
    panic("iderw: ide disk 1 not present");
80102357:	83 ec 0c             	sub    $0xc,%esp
8010235a:	68 35 81 10 80       	push   $0x80108135
8010235f:	e8 2c e0 ff ff       	call   80100390 <panic>
    panic("iderw: nothing to do");
80102364:	83 ec 0c             	sub    $0xc,%esp
80102367:	68 20 81 10 80       	push   $0x80108120
8010236c:	e8 1f e0 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102371:	83 ec 0c             	sub    $0xc,%esp
80102374:	68 0a 81 10 80       	push   $0x8010810a
...
80102385:	c7 05 14 40 11 80 00 	movl   $0xfec00000,0x80114014
8010238c:	00 c0 fe 
{
...
8010239a:	00 00 00 
  return ioapic->data;
8010239d:	8b 15 14 40 11 80    	mov    0x80114014,%edx
801023a3:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023a6:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023ac:	8b 0d 14 40 11 80    	mov    0x80114014,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023b2:	0f b6 15 40 41 11 80 	movzbl 0x80114140,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
801023ce:	68 54 81 10 80       	push   $0x80108154
801023d3:	e8 d8 e2 ff ff       	call   801006b0 <cprintf>
801023d8:	8b 0d 14 40 11 80    	mov    0x80114014,%ecx
...
801023f2:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
801023f4:	8b 0d 14 40 11 80    	mov    0x80114014,%ecx
...
8010240c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010240e:	8b 0d 14 40 11 80    	mov    0x80114014,%ecx
...
80102434:	55                   	push   %ebp
  ioapic->reg = reg;
80102435:	8b 0d 14 40 11 80    	mov    0x80114014,%ecx
{
...
80102447:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102449:	8b 0d 14 40 11 80    	mov    0x80114014,%ecx
...
80102458:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
8010245a:	a1 14 40 11 80       	mov    0x80114014,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102486:	81 fb c8 a6 11 80    	cmp    $0x8011a6c8,%ebx
...
801024a6:	e8 25 28 00 00       	call   80104cd0 <memset>

  if(kmem.use_lock)
801024ab:	8b 15 54 40 11 80    	mov    0x80114054,%edx
...
801024b8:	a1 58 40 11 80       	mov    0x80114058,%eax
801024bd:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
801024bf:	a1 54 40 11 80       	mov    0x80114054,%eax
  kmem.freelist = r;
801024c4:	89 1d 58 40 11 80    	mov    %ebx,0x80114058
  if(kmem.use_lock)
...
801024db:	68 20 40 11 80       	push   $0x80114020
801024e0:	e8 db 26 00 00       	call   80104bc0 <acquire>
801024e5:	83 c4 10             	add    $0x10,%esp
801024e8:	eb ce                	jmp    801024b8 <kfree+0x48>
801024ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
801024f0:	c7 45 08 20 40 11 80 	movl   $0x80114020,0x8(%ebp)
}
801024f7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 80 27 00 00       	jmp    80104c80 <release>
    panic("kfree");
80102500:	83 ec 0c             	sub    $0xc,%esp
80102503:	68 86 81 10 80       	push   $0x80108186
...
8010256f:	68 8c 81 10 80       	push   $0x8010818c
80102574:	68 20 40 11 80       	push   $0x80114020
80102579:	e8 c2 24 00 00       	call   80104a40 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
8010257e:	8b 45 08             	mov    0x8(%ebp),%eax
  for(; p + PGSIZE <= (char*)vend; p += PGSIZE)
80102581:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102584:	c7 05 54 40 11 80 00 	movl   $0x0,0x80114054
8010258b:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
80102612:	73 e4                	jae    801025f8 <kinit2+0x28>
  kmem.use_lock = 1;
80102614:	c7 05 54 40 11 80 01 	movl   $0x1,0x80114054
8010261b:	00 00 00 
}
...
80102630:	f3 0f 1e fb          	endbr32 
  ...
  if(kmem.use_lock)
80102634:	a1 54 40 11 80       	mov    0x80114054,%eax
80102639:	85 c0                	test   %eax,%eax
8010263b:	75 1b                	jne    80102658 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
8010263d:	a1 58 40 11 80       	mov    0x80114058,%eax
  if(r)
80102642:	85 c0                	test   %eax,%eax
80102644:	74 0a                	je     80102650 <kalloc+0x20>
    kmem.freelist = r->next;
80102646:	8b 10                	mov    (%eax),%edx
80102648:	89 15 58 40 11 80    	mov    %edx,0x80114058
  if(kmem.use_lock)
8010264e:	c3                   	ret    
8010264f:	90                   	nop
    release(&kmem.lock);
...
8010265b:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
8010265e:	68 20 40 11 80       	push   $0x80114020
80102663:	e8 58 25 00 00       	call   80104bc0 <acquire>
  r = kmem.freelist;
80102668:	a1 58 40 11 80       	mov    0x80114058,%eax
  if(r)
8010266d:	8b 15 54 40 11 80    	mov    0x80114054,%edx
80102673:	83 c4 10             	add    $0x10,%esp
80102676:	85 c0                	test   %eax,%eax
80102678:	74 08                	je     80102682 <kalloc+0x52>
    kmem.freelist = r->next;
8010267a:	8b 08                	mov    (%eax),%ecx
8010267c:	89 0d 58 40 11 80    	mov    %ecx,0x80114058
  if(kmem.use_lock)
...
8010268c:	68 20 40 11 80       	push   $0x80114020
80102691:	e8 ea 25 00 00       	call   80104c80 <release>
  return (char*)r;
...
801026bb:	ec                   	in     (%dx),%al
  return data;
801026bc:	8b 1d 54 b6 10 80    	mov    0x8010b654,%ebx
    return -1;
  data = inb(KBDATAP);
...
801026df:	0f b6 8a c0 82 10 80 	movzbl -0x7fef7d40(%edx),%ecx
  shift ^= togglecode[data];
801026e6:	0f b6 82 c0 81 10 80 	movzbl -0x7fef7e40(%edx),%eax
  shift |= shiftcode[data];
...
801026f1:	89 c8                	mov    %ecx,%eax
  shift ^= togglecode[data];
801026f3:	89 0d 54 b6 10 80    	mov    %ecx,0x8010b654
  c = charcode[shift & (CTL | SHIFT)][data];
801026f9:	83 e0 03             	and    $0x3,%eax
  if(shift & CAPSLOCK){
801026fc:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801026ff:	8b 04 85 a0 81 10 80 	mov    -0x7fef7e60(,%eax,4),%eax
...
80102723:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102725:	89 1d 54 b6 10 80    	mov    %ebx,0x8010b654
}
8010272b:	5b                   	pop    %ebx
8010272c:	5d                   	pop    %ebp
8010272d:	c3                   	ret    
...
80102738:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
8010273a:	0f b6 8a c0 82 10 80 	movzbl -0x7fef7d40(%edx),%ecx
...
8010274c:	5d                   	pop    %ebp
    shift &= ~(shiftcode[data] | E0ESC);
8010274d:	89 0d 54 b6 10 80    	mov    %ecx,0x8010b654
}
80102753:	c3                   	ret    
...
801027a0:	f3 0f 1e fb          	endbr32 
  if(!lapic)
801027a4:	a1 5c 40 11 80       	mov    0x8011405c,%eax
...
801028a0:	f3 0f 1e fb          	endbr32 
  if (!lapic)
801028a4:	a1 5c 40 11 80       	mov    0x8011405c,%eax
...
801028c0:	f3 0f 1e fb          	endbr32 
  if(lapic)
801028c4:	a1 5c 40 11 80       	mov    0x8011405c,%eax
...
8010292c:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
80102932:	a1 5c 40 11 80       	mov    0x8011405c,%eax
...
80102abf:	e8 5c 22 00 00       	call   80104d20 <memcmp>
...
80102b90:	8b 0d a8 40 11 80    	mov    0x801140a8,%ecx
...
80102bb0:	a1 94 40 11 80       	mov    0x80114094,%eax
80102bb5:	83 ec 08             	sub    $0x8,%esp
80102bb8:	01 f8                	add    %edi,%eax
80102bba:	83 c0 01             	add    $0x1,%eax
80102bbd:	50                   	push   %eax
80102bbe:	ff 35 a4 40 11 80    	pushl  0x801140a4
80102bc4:	e8 07 d5 ff ff       	call   801000d0 <bread>
80102bc9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bcb:	58                   	pop    %eax
80102bcc:	5a                   	pop    %edx
80102bcd:	ff 34 bd ac 40 11 80 	pushl  -0x7feebf54(,%edi,4)
80102bd4:	ff 35 a4 40 11 80    	pushl  0x801140a4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102bf4:	e8 77 21 00 00       	call   80104d70 <memmove>
...
80102c14:	39 3d a8 40 11 80    	cmp    %edi,0x801140a8
...
80102c37:	ff 35 94 40 11 80    	pushl  0x80114094
80102c3d:	ff 35 a4 40 11 80    	pushl  0x801140a4
...
80102c4b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c4d:	a1 a8 40 11 80       	mov    0x801140a8,%eax
...
80102c60:	8b 0c 95 ac 40 11 80 	mov    -0x7feebf54(,%edx,4),%ecx
...
80102c9e:	68 c0 83 10 80       	push   $0x801083c0
80102ca3:	68 60 40 11 80       	push   $0x80114060
80102ca8:	e8 93 1d 00 00       	call   80104a40 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102cbc:	59                   	pop    %ecx
  log.dev = dev;
80102cbd:	89 1d a4 40 11 80    	mov    %ebx,0x801140a4
  log.size = sb.nlog;
80102cc3:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cc6:	a3 94 40 11 80       	mov    %eax,0x80114094
  log.size = sb.nlog;
80102ccb:	89 15 98 40 11 80    	mov    %edx,0x80114098
  struct buf *buf = bread(log.dev, log.start);
80102cd1:	5a                   	pop    %edx
...
80102cdf:	89 0d a8 40 11 80    	mov    %ecx,0x801140a8
  for (i = 0; i < log.lh.n; i++) {
...
80102cf4:	89 1c 95 ac 40 11 80 	mov    %ebx,-0x7feebf54(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d0b:	e8 80 fe ff ff       	call   80102b90 <install_trans>
  log.lh.n = 0;
80102d10:	c7 05 a8 40 11 80 00 	movl   $0x0,0x801140a8
80102d17:	00 00 00 
...
80102d37:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d3a:	68 60 40 11 80       	push   $0x80114060
80102d3f:	e8 7c 1e 00 00       	call   80104bc0 <acquire>
...
80102d53:	68 60 40 11 80       	push   $0x80114060
80102d58:	68 60 40 11 80       	push   $0x80114060
80102d5d:	e8 9e 13 00 00       	call   80104100 <sleep>
80102d62:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d65:	a1 a0 40 11 80       	mov    0x801140a0,%eax
80102d6a:	85 c0                	test   %eax,%eax
80102d6c:	75 e2                	jne    80102d50 <begin_op+0x20>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d6e:	a1 9c 40 11 80       	mov    0x8011409c,%eax
80102d73:	8b 15 a8 40 11 80    	mov    0x801140a8,%edx
...
80102d87:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102d8a:	a3 9c 40 11 80       	mov    %eax,0x8011409c
      release(&log.lock);
80102d8f:	68 60 40 11 80       	push   $0x80114060
80102d94:	e8 e7 1e 00 00       	call   80104c80 <release>
      break;
    }
  }
}
...
80102daa:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dad:	68 60 40 11 80       	push   $0x80114060
80102db2:	e8 09 1e 00 00       	call   80104bc0 <acquire>
  log.outstanding -= 1;
80102db7:	a1 9c 40 11 80       	mov    0x8011409c,%eax
  if(log.committing)
80102dbc:	8b 35 a0 40 11 80    	mov    0x801140a0,%esi
80102dc2:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102dc5:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102dc8:	89 1d 9c 40 11 80    	mov    %ebx,0x8011409c
  if(log.committing)
...
80102dd8:	0f 85 f2 00 00 00    	jne    80102ed0 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102dde:	c7 05 a0 40 11 80 01 	movl   $0x1,0x801140a0
80102de5:	00 00 00 
...
80102deb:	68 60 40 11 80       	push   $0x80114060
80102df0:	e8 8b 1e 00 00       	call   80104c80 <release>
}
...
{
  if (log.lh.n > 0) {
80102df5:	8b 0d a8 40 11 80    	mov    0x801140a8,%ecx
80102dfb:	83 c4 10             	add    $0x10,%esp
80102dfe:	85 c9                	test   %ecx,%ecx
80102e00:	7f 3e                	jg     80102e40 <end_op+0xa0>
    acquire(&log.lock);
80102e02:	83 ec 0c             	sub    $0xc,%esp
80102e05:	68 60 40 11 80       	push   $0x80114060
80102e0a:	e8 b1 1d 00 00       	call   80104bc0 <acquire>
    wakeup(&log);
80102e0f:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
    log.committing = 0;
80102e16:	c7 05 a0 40 11 80 00 	movl   $0x0,0x801140a0
80102e1d:	00 00 00 
    wakeup(&log);
80102e20:	e8 9b 14 00 00       	call   801042c0 <wakeup>
    release(&log.lock);
80102e25:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
80102e2c:	e8 4f 1e 00 00       	call   80104c80 <release>
...
80102e40:	a1 94 40 11 80       	mov    0x80114094,%eax
80102e45:	83 ec 08             	sub    $0x8,%esp
80102e48:	01 d8                	add    %ebx,%eax
80102e4a:	83 c0 01             	add    $0x1,%eax
80102e4d:	50                   	push   %eax
80102e4e:	ff 35 a4 40 11 80    	pushl  0x801140a4
80102e54:	e8 77 d2 ff ff       	call   801000d0 <bread>
80102e59:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e5b:	58                   	pop    %eax
80102e5c:	5a                   	pop    %edx
80102e5d:	ff 34 9d ac 40 11 80 	pushl  -0x7feebf54(,%ebx,4)
80102e64:	ff 35 a4 40 11 80    	pushl  0x801140a4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102e84:	e8 e7 1e 00 00       	call   80104d70 <memmove>
...
80102ea4:	3b 1d a8 40 11 80    	cmp    0x801140a8,%ebx
...
80102eb1:	e8 da fc ff ff       	call   80102b90 <install_trans>
    log.lh.n = 0;
80102eb6:	c7 05 a8 40 11 80 00 	movl   $0x0,0x801140a8
80102ebd:	00 00 00 
...
80102ed3:	68 60 40 11 80       	push   $0x80114060
80102ed8:	e8 e3 13 00 00       	call   801042c0 <wakeup>
  release(&log.lock);
80102edd:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
80102ee4:	e8 97 1d 00 00       	call   80104c80 <release>
...
80102ef7:	68 c4 83 10 80       	push   $0x801083c4
...
80102f1b:	8b 15 a8 40 11 80    	mov    0x801140a8,%edx
{
80102f21:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f24:	83 fa 1d             	cmp    $0x1d,%edx
80102f27:	0f 8f 91 00 00 00    	jg     80102fbe <log_write+0xae>
80102f2d:	a1 98 40 11 80       	mov    0x80114098,%eax
80102f32:	83 e8 01             	sub    $0x1,%eax
80102f35:	39 c2                	cmp    %eax,%edx
80102f37:	0f 8d 81 00 00 00    	jge    80102fbe <log_write+0xae>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f3d:	a1 9c 40 11 80       	mov    0x8011409c,%eax
...
80102f4d:	68 60 40 11 80       	push   $0x80114060
80102f52:	e8 69 1c 00 00       	call   80104bc0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f57:	8b 15 a8 40 11 80    	mov    0x801140a8,%edx
...
80102f75:	74 29                	je     80102fa0 <log_write+0x90>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f77:	39 0c 85 ac 40 11 80 	cmp    %ecx,-0x7feebf54(,%eax,4)
80102f7e:	75 f0                	jne    80102f70 <log_write+0x60>
      break;
  }
  log.lh.block[i] = b->blockno;
80102f80:	89 0c 85 ac 40 11 80 	mov    %ecx,-0x7feebf54(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102f8a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102f8d:	c7 45 08 60 40 11 80 	movl   $0x80114060,0x8(%ebp)
}
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 e6 1c 00 00       	jmp    80104c80 <release>
80102f9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 95 ac 40 11 80 	mov    %ecx,-0x7feebf54(,%edx,4)
    log.lh.n++;
80102fa7:	83 c2 01             	add    $0x1,%edx
80102faa:	89 15 a8 40 11 80    	mov    %edx,0x801140a8
80102fb0:	eb d5                	jmp    80102f87 <log_write+0x77>
  log.lh.block[i] = b->blockno;
80102fb2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fb5:	a3 ac 40 11 80       	mov    %eax,0x801140ac
  if (i == log.lh.n)
80102fba:	75 cb                	jne    80102f87 <log_write+0x77>
80102fbc:	eb e9                	jmp    80102fa7 <log_write+0x97>
    panic("too big a transaction");
80102fbe:	83 ec 0c             	sub    $0xc,%esp
80102fc1:	68 d3 83 10 80       	push   $0x801083d3
80102fc6:	e8 c5 d3 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102fcb:	83 ec 0c             	sub    $0xc,%esp
80102fce:	68 e9 83 10 80       	push   $0x801083e9
...
80102ff8:	68 04 84 10 80       	push   $0x80108404
80102ffd:	e8 ae d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80103002:	e8 69 36 00 00       	call   80106670 <idtinit>
...
8010305b:	68 c8 a6 11 80       	push   $0x8011a6c8
...
8010308d:	e8 2e 08 00 00       	call   801038c0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 59 35 00 00       	call   801065f0 <tvinit>
  binit();         // buffer cache
...
801030ae:	68 2c b5 10 80       	push   $0x8010b52c
801030b3:	68 00 70 00 80       	push   $0x80007000
801030b8:	e8 b3 1c 00 00       	call   80104d70 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801030bd:	83 c4 10             	add    $0x10,%esp
801030c0:	69 05 e0 46 11 80 b0 	imul   $0xb0,0x801146e0,%eax
801030c7:	00 00 00 
801030ca:	05 60 41 11 80       	add    $0x80114160,%eax
801030cf:	3d 60 41 11 80       	cmp    $0x80114160,%eax
801030d4:	76 7a                	jbe    80103150 <main+0x110>
801030d6:	bb 60 41 11 80       	mov    $0x80114160,%ebx
801030db:	eb 1c                	jmp    801030f9 <main+0xb9>
801030dd:	8d 76 00             	lea    0x0(%esi),%esi
801030e0:	69 05 e0 46 11 80 b0 	imul   $0xb0,0x801146e0,%eax
801030e7:	00 00 00 
801030ea:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
801030f0:	05 60 41 11 80       	add    $0x80114160,%eax
...
8010319e:	68 18 84 10 80       	push   $0x80108418
801031a3:	56                   	push   %esi
801031a4:	e8 77 1b 00 00       	call   80104d20 <memcmp>
...
8010325a:	68 1d 84 10 80       	push   $0x8010841d
8010325f:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 b8 1a 00 00       	call   80104d20 <memcmp>
...
801032be:	a3 5c 40 11 80       	mov    %eax,0x8011405c
...
8010334c:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
8010334f:	88 0d 40 41 11 80    	mov    %cl,0x80114140
      continue;
80103355:	eb 89                	jmp    801032e0 <mpinit+0xf0>
80103357:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010335e:	66 90                	xchg   %ax,%ax
      if(ncpu < NCPU) {
80103360:	8b 0d e0 46 11 80    	mov    0x801146e0,%ecx
...
80103378:	89 0d e0 46 11 80    	mov    %ecx,0x801146e0
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f 60 41 11 80    	mov    %bl,-0x7feebea0(%edi)
...
801033b3:	68 22 84 10 80       	push   $0x80108422
801033b8:	e8 d3 cf ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801033bd:	83 ec 0c             	sub    $0xc,%esp
801033c0:	68 3c 84 10 80       	push   $0x8010843c
...
80103464:	00 00 00 
  initlock(&p->lock, "pipe");
80103467:	68 33 87 10 80       	push   $0x80108733
8010346c:	50                   	push   %eax
8010346d:	e8 ce 15 00 00       	call   80104a40 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 a8 16 00 00       	call   80104bc0 <acquire>
  if(writable){
...
80103533:	e8 88 0d 00 00       	call   801042c0 <wakeup>
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 23 17 00 00       	jmp    80104c80 <release>
...
80103574:	e8 47 0d 00 00       	call   801042c0 <wakeup>
...
80103584:	e8 f7 16 00 00       	call   80104c80 <release>
    kfree((char*)p);
...
801035b1:	e8 0a 16 00 00       	call   80104bc0 <acquire>
  for(i = 0; i < n; i++){
...
80103608:	e8 b3 0c 00 00       	call   801042c0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010360d:	58                   	pop    %eax
8010360e:	5a                   	pop    %edx
8010360f:	53                   	push   %ebx
80103610:	56                   	push   %esi
80103611:	e8 ea 0a 00 00       	call   80104100 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
8010363c:	e8 3f 16 00 00       	call   80104c80 <release>
        return -1;
...
8010368a:	e8 31 0c 00 00       	call   801042c0 <wakeup>
  release(&p->lock);
8010368f:	89 1c 24             	mov    %ebx,(%esp)
80103692:	e8 e9 15 00 00       	call   80104c80 <release>
  return n;
...
801036ba:	e8 01 15 00 00       	call   80104bc0 <acquire>
...
801036ed:	e8 0e 0a 00 00       	call   80104100 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103756:	e8 65 0b 00 00       	call   801042c0 <wakeup>
  release(&p->lock);
8010375b:	89 34 24             	mov    %esi,(%esp)
8010375e:	e8 1d 15 00 00       	call   80104c80 <release>
  return i;
...
80103779:	e8 02 15 00 00       	call   80104c80 <release>
      return -1;
...
80103794:	bb 34 47 11 80       	mov    $0x80114734,%ebx
{
80103799:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010379c:	68 00 47 11 80       	push   $0x80114700
801037a1:	e8 1a 14 00 00       	call   80104bc0 <acquire>
...
801037b6:	81 fb 34 6f 11 80    	cmp    $0x80116f34,%ebx
...
801037d1:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->sched_policy = -1;  // by default it will be round robin
801037d8:	c7 83 80 00 00 00 ff 	movl   $0xffffffff,0x80(%ebx)
801037df:	ff ff ff 
  p->pid = nextpid++;
...
801037ed:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
801037f3:	e8 88 14 00 00       	call   80104c80 <release>
...
80103805:	74 52                	je     80103859 <allocproc+0xc9>
    return 0;
  }
...
80103810:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103815:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103818:	c7 40 14 da 65 10 80 	movl   $0x801065da,0x14(%eax)
  p->context = (struct context*)sp;
8010381f:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103822:	6a 14                	push   $0x14
80103824:	6a 00                	push   $0x0
80103826:	50                   	push   %eax
80103827:	e8 a4 14 00 00       	call   80104cd0 <memset>
...
80103843:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103845:	68 00 47 11 80       	push   $0x80114700
8010384a:	e8 31 14 00 00       	call   80104c80 <release>
}
...
80103877:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010387a:	68 00 47 11 80       	push   $0x80114700
8010387f:	e8 fc 13 00 00       	call   80104c80 <release>
...
801038ca:	68 5b 84 10 80       	push   $0x8010845b
801038cf:	68 00 47 11 80       	push   $0x80114700
801038d4:	e8 67 11 00 00       	call   80104a40 <initlock>
}
...
801038f0:	e8 ab ef ff ff       	call   801028a0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
801038f5:	8b 35 e0 46 11 80    	mov    0x801146e0,%esi
  apicid = lapicid();
...
80103915:	0f b6 81 60 41 11 80 	movzbl -0x7feebea0(%ecx),%eax
8010391c:	39 d8                	cmp    %ebx,%eax
8010391e:	75 e8                	jne    80103908 <mycpu+0x28>
}
80103920:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103923:	8d 81 60 41 11 80    	lea    -0x7feebea0(%ecx),%eax
}
80103929:	5b                   	pop    %ebx
8010392a:	5e                   	pop    %esi
8010392b:	5d                   	pop    %ebp
...
8010395f:	c9                   	leave  
  return mycpu()-cpus;
80103960:	2d 60 41 11 80       	sub    $0x80114160,%eax
...
80103978:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010397b:	e8 40 11 00 00       	call   80104ac0 <pushcli>
  c = mycpu();
80103980:	e8 5b ff ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103985:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010398b:	e8 80 11 00 00       	call   80104b10 <popcli>
}
...
801039b0:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039b2:	a3 58 b6 10 80       	mov    %eax,0x8010b658
  if((p->pgdir = setupkvm()) == 0)
801039b7:	e8 54 42 00 00       	call   80107c10 <setupkvm>
801039bc:	89 43 04             	mov    %eax,0x4(%ebx)
801039bf:	85 c0                	test   %eax,%eax
801039c1:	0f 84 c8 00 00 00    	je     80103a8f <userinit+0xef>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801039c7:	83 ec 04             	sub    $0x4,%esp
801039ca:	68 2c 00 00 00       	push   $0x2c
801039cf:	68 00 b5 10 80       	push   $0x8010b500
801039d4:	50                   	push   %eax
801039d5:	e8 06 3f 00 00       	call   801078e0 <inituvm>
...
801039ea:	e8 e1 12 00 00       	call   80104cd0 <memset>
...
80103a43:	68 8b 84 10 80       	push   $0x8010848b
80103a48:	50                   	push   %eax
80103a49:	e8 42 14 00 00       	call   80104e90 <safestrcpy>
  p->cwd = namei("/");
80103a4e:	c7 04 24 94 84 10 80 	movl   $0x80108494,(%esp)
80103a55:	e8 d6 e5 ff ff       	call   80102030 <namei>
80103a5a:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a5d:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
80103a64:	e8 57 11 00 00       	call   80104bc0 <acquire>
  p->arrival = ticks;
80103a69:	a1 c0 a6 11 80       	mov    0x8011a6c0,%eax
  p->state = RUNNABLE;
80103a6e:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  p->arrival = ticks;
80103a75:	89 83 9c 00 00 00    	mov    %eax,0x9c(%ebx)
  release(&ptable.lock);
80103a7b:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
80103a82:	e8 f9 11 00 00       	call   80104c80 <release>
}
...
80103a92:	68 72 84 10 80       	push   $0x80108472
80103a97:	e8 f4 c8 ff ff       	call   80100390 <panic>
...
80103aa9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aac:	e8 0f 10 00 00       	call   80104ac0 <pushcli>
  c = mycpu();
80103ab1:	e8 2a fe ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103ab6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103abc:	e8 4f 10 00 00       	call   80104b10 <popcli>
  sz = curproc->sz;
...
80103acf:	e8 fc 3c 00 00       	call   801077d0 <switchuvm>
  return 0;
...
80103aea:	e8 41 3f 00 00       	call   80107a30 <allocuvm>
...
80103b0a:	e8 51 40 00 00       	call   80107b60 <deallocuvm>
...
80103bd9:	e8 b2 12 00 00       	call   80104e90 <safestrcpy>
  pid = np->pid;
80103bde:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103be1:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
80103be8:	e8 d3 0f 00 00       	call   80104bc0 <acquire>
  np->arrival = ticks;
80103bed:	a1 c0 a6 11 80       	mov    0x8011a6c0,%eax
  np->state = RUNNABLE;
80103bf2:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  np->arrival = ticks;
80103bf9:	89 87 9c 00 00 00    	mov    %eax,0x9c(%edi)
  release(&ptable.lock);
80103bff:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
80103c06:	e8 75 10 00 00       	call   80104c80 <release>
  return pid;
...
80103c1d:	eb ef                	jmp    80103c0e <fork+0xee>
    kfree(np->kstack);
80103c1f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103c22:	83 ec 0c             	sub    $0xc,%esp
    return -1;
80103c25:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    kfree(np->kstack);
80103c2a:	ff 77 08             	pushl  0x8(%edi)
80103c2d:	e8 3e e8 ff ff       	call   80102470 <kfree>
    np->kstack = 0;
80103c32:	c7 47 08 00 00 00 00 	movl   $0x0,0x8(%edi)
    return -1;
80103c39:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c3c:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    return -1;
80103c43:	eb c9                	jmp    80103c0e <fork+0xee>
80103c45:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80103c5c:	83 ec 2c             	sub    $0x2c,%esp
  struct cpu *c = mycpu();
80103c5f:	e8 7c fc ff ff       	call   801038e0 <mycpu>
  c->proc = 0;
80103c64:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103c6b:	00 00 00 
  struct cpu *c = mycpu();
80103c6e:	89 c6                	mov    %eax,%esi
  c->proc = 0;
80103c70:	8d 40 04             	lea    0x4(%eax),%eax
80103c73:	89 45 d0             	mov    %eax,-0x30(%ebp)
...
80103c84:	68 00 47 11 80       	push   $0x80114700
80103c89:	e8 32 0f 00 00       	call   80104bc0 <acquire>
80103c8e:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c91:	b8 34 47 11 80       	mov    $0x80114734,%eax
      if(p->state != RUNNABLE)
80103c96:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103c9a:	0f 84 a8 00 00 00    	je     80103d48 <scheduler+0xf8>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ca0:	05 a0 00 00 00       	add    $0xa0,%eax
80103ca5:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80103caa:	75 ea                	jne    80103c96 <scheduler+0x46>
    release(&ptable.lock);
80103cac:	83 ec 0c             	sub    $0xc,%esp
80103caf:	68 00 47 11 80       	push   $0x80114700
80103cb4:	e8 c7 0f 00 00       	call   80104c80 <release>
80103cb9:	83 c4 10             	add    $0x10,%esp
      acquire(&ptable.lock);
80103cbc:	83 ec 0c             	sub    $0xc,%esp
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cbf:	bb 34 47 11 80       	mov    $0x80114734,%ebx
      acquire(&ptable.lock);
80103cc4:	68 00 47 11 80       	push   $0x80114700
80103cc9:	e8 f2 0e 00 00       	call   80104bc0 <acquire>
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cce:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80103cd1:	89 f7                	mov    %esi,%edi
80103cd3:	8b 75 d0             	mov    -0x30(%ebp),%esi
      acquire(&ptable.lock);
80103cd6:	83 c4 10             	add    $0x10,%esp
80103cd9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        if(p->state != RUNNABLE)
80103ce0:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103ce4:	75 33                	jne    80103d19 <scheduler+0xc9>
        switchuvm(p);
80103ce6:	83 ec 0c             	sub    $0xc,%esp
        c->proc = p;
80103ce9:	89 9f ac 00 00 00    	mov    %ebx,0xac(%edi)
        switchuvm(p);
80103cef:	53                   	push   %ebx
80103cf0:	e8 db 3a 00 00       	call   801077d0 <switchuvm>
        p->state = RUNNING;
80103cf5:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
        swtch(&(c->scheduler), p->context);
80103cfc:	59                   	pop    %ecx
80103cfd:	58                   	pop    %eax
80103cfe:	ff 73 1c             	pushl  0x1c(%ebx)
80103d01:	56                   	push   %esi
80103d02:	e8 ec 11 00 00       	call   80104ef3 <swtch>
        switchkvm();
80103d07:	e8 a4 3a 00 00       	call   801077b0 <switchkvm>
        c->proc = 0;
80103d0c:	83 c4 10             	add    $0x10,%esp
80103d0f:	c7 87 ac 00 00 00 00 	movl   $0x0,0xac(%edi)
80103d16:	00 00 00 
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d19:	81 c3 a0 00 00 00    	add    $0xa0,%ebx
80103d1f:	81 fb 34 6f 11 80    	cmp    $0x80116f34,%ebx
80103d25:	75 b9                	jne    80103ce0 <scheduler+0x90>
      release(&ptable.lock);
80103d27:	83 ec 0c             	sub    $0xc,%esp
80103d2a:	89 fe                	mov    %edi,%esi
80103d2c:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103d2f:	68 00 47 11 80       	push   $0x80114700
80103d34:	e8 47 0f 00 00       	call   80104c80 <release>
80103d39:	83 c4 10             	add    $0x10,%esp
80103d3c:	e9 3f ff ff ff       	jmp    80103c80 <scheduler+0x30>
80103d41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&ptable.lock);
80103d48:	83 ec 0c             	sub    $0xc,%esp
      policy = p->sched_policy;
80103d4b:	8b 98 80 00 00 00    	mov    0x80(%eax),%ebx
    release(&ptable.lock);
80103d51:	68 00 47 11 80       	push   $0x80114700
80103d56:	e8 25 0f 00 00       	call   80104c80 <release>
    if (policy == -1) {   // default
80103d5b:	83 c4 10             	add    $0x10,%esp
80103d5e:	83 fb ff             	cmp    $0xffffffff,%ebx
80103d61:	0f 84 55 ff ff ff    	je     80103cbc <scheduler+0x6c>
    if (policy == 0 || policy == 1) {
80103d67:	83 fb 01             	cmp    $0x1,%ebx
80103d6a:	0f 87 10 ff ff ff    	ja     80103c80 <scheduler+0x30>
      acquire(&ptable.lock);
80103d70:	83 ec 0c             	sub    $0xc,%esp
80103d73:	68 00 47 11 80       	push   $0x80114700
80103d78:	e8 43 0e 00 00       	call   80104bc0 <acquire>
    uint minP = 1000, pid_2 = 100;
80103d7d:	ba e8 03 00 00       	mov    $0x3e8,%edx
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d82:	89 75 d4             	mov    %esi,-0x2c(%ebp)
      acquire(&ptable.lock);
80103d85:	83 c4 10             	add    $0x10,%esp
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d88:	89 7d e0             	mov    %edi,-0x20(%ebp)
    uint minD = 100000, pid_1 = 100;
80103d8b:	b9 a0 86 01 00       	mov    $0x186a0,%ecx
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d90:	b8 34 47 11 80       	mov    $0x80114734,%eax
80103d95:	89 d6                	mov    %edx,%esi
    int found = 0, policy = -1;
80103d97:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    uint minP = 1000, pid_2 = 100;
80103d9e:	c7 45 d8 64 00 00 00 	movl   $0x64,-0x28(%ebp)
    uint minD = 100000, pid_1 = 100;
80103da5:	c7 45 dc 64 00 00 00 	movl   $0x64,-0x24(%ebp)
80103dac:	eb 2e                	jmp    80103ddc <scheduler+0x18c>
80103dae:	66 90                	xchg   %ax,%ax
          if ((p->weight < minP) || (p->weight == minP && p->pid < pid_2)) {
80103db0:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
80103db6:	39 f2                	cmp    %esi,%edx
80103db8:	0f 83 d2 00 00 00    	jae    80103e90 <scheduler+0x240>
80103dbe:	8b 70 10             	mov    0x10(%eax),%esi
80103dc1:	89 75 d8             	mov    %esi,-0x28(%ebp)
80103dc4:	89 45 e0             	mov    %eax,-0x20(%ebp)
80103dc7:	89 d6                	mov    %edx,%esi
            found = 1;
80103dc9:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dd0:	05 a0 00 00 00       	add    $0xa0,%eax
80103dd5:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80103dda:	74 3c                	je     80103e18 <scheduler+0x1c8>
        if(p->state != RUNNABLE)
80103ddc:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103de0:	75 ee                	jne    80103dd0 <scheduler+0x180>
        if (policy == 0) {    // edf
80103de2:	85 db                	test   %ebx,%ebx
80103de4:	75 ca                	jne    80103db0 <scheduler+0x160>
          if ((p->deadline < minD) || (p->deadline == minD && p->pid < pid_1)) {
80103de6:	8b 90 98 00 00 00    	mov    0x98(%eax),%edx
80103dec:	39 ca                	cmp    %ecx,%edx
80103dee:	0f 83 7c 00 00 00    	jae    80103e70 <scheduler+0x220>
80103df4:	8b 48 10             	mov    0x10(%eax),%ecx
80103df7:	89 4d dc             	mov    %ecx,-0x24(%ebp)
80103dfa:	89 45 e0             	mov    %eax,-0x20(%ebp)
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dfd:	05 a0 00 00 00       	add    $0xa0,%eax
          if ((p->deadline < minD) || (p->deadline == minD && p->pid < pid_1)) {
80103e02:	89 d1                	mov    %edx,%ecx
            found = 1;
80103e04:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e0b:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80103e10:	75 ca                	jne    80103ddc <scheduler+0x18c>
80103e12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if (found == 1) {
80103e18:	83 7d e4 01          	cmpl   $0x1,-0x1c(%ebp)
80103e1c:	8b 7d e0             	mov    -0x20(%ebp),%edi
80103e1f:	8b 75 d4             	mov    -0x2c(%ebp),%esi
80103e22:	75 35                	jne    80103e59 <scheduler+0x209>
        switchuvm(new);
80103e24:	83 ec 0c             	sub    $0xc,%esp
        c->proc = new;
80103e27:	89 be ac 00 00 00    	mov    %edi,0xac(%esi)
        switchuvm(new);
80103e2d:	57                   	push   %edi
80103e2e:	e8 9d 39 00 00       	call   801077d0 <switchuvm>
        new->state = RUNNING;
...
80103e3f:	ff 75 d0             	pushl  -0x30(%ebp)
80103e42:	e8 ac 10 00 00       	call   80104ef3 <swtch>
        switchkvm();
80103e47:	e8 64 39 00 00       	call   801077b0 <switchkvm>
        c->proc = 0;
...
80103e5c:	68 00 47 11 80       	push   $0x80114700
80103e61:	e8 1a 0e 00 00       	call   80104c80 <release>
80103e66:	83 c4 10             	add    $0x10,%esp
80103e69:	e9 12 fe ff ff       	jmp    80103c80 <scheduler+0x30>
80103e6e:	66 90                	xchg   %ax,%ax
          if ((p->deadline < minD) || (p->deadline == minD && p->pid < pid_1)) {
80103e70:	0f 85 5a ff ff ff    	jne    80103dd0 <scheduler+0x180>
80103e76:	8b 78 10             	mov    0x10(%eax),%edi
80103e79:	3b 7d dc             	cmp    -0x24(%ebp),%edi
80103e7c:	0f 83 4e ff ff ff    	jae    80103dd0 <scheduler+0x180>
80103e82:	89 7d dc             	mov    %edi,-0x24(%ebp)
80103e85:	e9 70 ff ff ff       	jmp    80103dfa <scheduler+0x1aa>
80103e8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
          if ((p->weight < minP) || (p->weight == minP && p->pid < pid_2)) {
80103e90:	0f 85 3a ff ff ff    	jne    80103dd0 <scheduler+0x180>
80103e96:	8b 78 10             	mov    0x10(%eax),%edi
80103e99:	3b 7d d8             	cmp    -0x28(%ebp),%edi
80103e9c:	0f 83 2e ff ff ff    	jae    80103dd0 <scheduler+0x180>
80103ea2:	89 7d d8             	mov    %edi,-0x28(%ebp)
80103ea5:	e9 1a ff ff ff       	jmp    80103dc4 <scheduler+0x174>
...
80103eb8:	53                   	push   %ebx
  pushcli();
80103eb9:	e8 02 0c 00 00       	call   80104ac0 <pushcli>
  c = mycpu();
80103ebe:	e8 1d fa ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103ec3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ec9:	e8 42 0c 00 00       	call   80104b10 <popcli>
  if(!holding(&ptable.lock))
80103ece:	83 ec 0c             	sub    $0xc,%esp
80103ed1:	68 00 47 11 80       	push   $0x80114700
80103ed6:	e8 95 0c 00 00       	call   80104b70 <holding>
80103edb:	83 c4 10             	add    $0x10,%esp
80103ede:	85 c0                	test   %eax,%eax
80103ee0:	74 4f                	je     80103f31 <sched+0x81>
  if(mycpu()->ncli != 1)
80103ee2:	e8 f9 f9 ff ff       	call   801038e0 <mycpu>
80103ee7:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103eee:	75 68                	jne    80103f58 <sched+0xa8>
  if(p->state == RUNNING)
80103ef0:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
80103ef4:	74 55                	je     80103f4b <sched+0x9b>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80103ef6:	9c                   	pushf  
80103ef7:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103ef8:	f6 c4 02             	test   $0x2,%ah
80103efb:	75 41                	jne    80103f3e <sched+0x8e>
  intena = mycpu()->intena;
80103efd:	e8 de f9 ff ff       	call   801038e0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103f02:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103f05:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103f0b:	e8 d0 f9 ff ff       	call   801038e0 <mycpu>
80103f10:	83 ec 08             	sub    $0x8,%esp
80103f13:	ff 70 04             	pushl  0x4(%eax)
80103f16:	53                   	push   %ebx
80103f17:	e8 d7 0f 00 00       	call   80104ef3 <swtch>
  mycpu()->intena = intena;
80103f1c:	e8 bf f9 ff ff       	call   801038e0 <mycpu>
}
80103f21:	83 c4 10             	add    $0x10,%esp
  mycpu()->intena = intena;
80103f24:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
80103f2a:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103f2d:	5b                   	pop    %ebx
80103f2e:	5e                   	pop    %esi
80103f2f:	5d                   	pop    %ebp
80103f30:	c3                   	ret    
...
80103f34:	68 96 84 10 80       	push   $0x80108496
80103f39:	e8 52 c4 ff ff       	call   80100390 <panic>
    panic("sched interruptible");
80103f3e:	83 ec 0c             	sub    $0xc,%esp
80103f41:	68 c2 84 10 80       	push   $0x801084c2
80103f46:	e8 45 c4 ff ff       	call   80100390 <panic>
    panic("sched running");
80103f4b:	83 ec 0c             	sub    $0xc,%esp
80103f4e:	68 b4 84 10 80       	push   $0x801084b4
80103f53:	e8 38 c4 ff ff       	call   80100390 <panic>
    panic("sched locks");
80103f58:	83 ec 0c             	sub    $0xc,%esp
80103f5b:	68 a8 84 10 80       	push   $0x801084a8
80103f60:	e8 2b c4 ff ff       	call   80100390 <panic>
80103f65:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80103f7a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103f7d:	e8 3e 0b 00 00       	call   80104ac0 <pushcli>
  c = mycpu();
80103f82:	e8 59 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103f87:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f8d:	e8 7e 0b 00 00       	call   80104b10 <popcli>
  if(curproc == initproc)
80103f92:	8d 5e 28             	lea    0x28(%esi),%ebx
80103f95:	8d 7e 68             	lea    0x68(%esi),%edi
80103f98:	39 35 58 b6 10 80    	cmp    %esi,0x8010b658
80103f9e:	0f 84 fd 00 00 00    	je     801040a1 <exit+0x131>
80103fa4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd]){
80103fa8:	8b 03                	mov    (%ebx),%eax
80103faa:	85 c0                	test   %eax,%eax
80103fac:	74 12                	je     80103fc0 <exit+0x50>
      fileclose(curproc->ofile[fd]);
80103fae:	83 ec 0c             	sub    $0xc,%esp
80103fb1:	50                   	push   %eax
80103fb2:	e8 09 cf ff ff       	call   80100ec0 <fileclose>
      curproc->ofile[fd] = 0;
80103fb7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80103fbd:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
80103fc0:	83 c3 04             	add    $0x4,%ebx
80103fc3:	39 df                	cmp    %ebx,%edi
80103fc5:	75 e1                	jne    80103fa8 <exit+0x38>
  begin_op();
80103fc7:	e8 64 ed ff ff       	call   80102d30 <begin_op>
  iput(curproc->cwd);
80103fcc:	83 ec 0c             	sub    $0xc,%esp
80103fcf:	ff 76 68             	pushl  0x68(%esi)
80103fd2:	e8 b9 d8 ff ff       	call   80101890 <iput>
  end_op();
80103fd7:	e8 c4 ed ff ff       	call   80102da0 <end_op>
  curproc->cwd = 0;
80103fdc:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103fe3:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
80103fea:	e8 d1 0b 00 00       	call   80104bc0 <acquire>
  wakeup1(curproc->parent);
80103fef:	8b 56 14             	mov    0x14(%esi),%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ff5:	b8 34 47 11 80       	mov    $0x80114734,%eax
80103ffa:	eb 10                	jmp    8010400c <exit+0x9c>
80103ffc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104000:	05 a0 00 00 00       	add    $0xa0,%eax
80104005:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
8010400a:	74 1e                	je     8010402a <exit+0xba>
    if(p->state == SLEEPING && p->chan == chan) {
8010400c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104010:	75 ee                	jne    80104000 <exit+0x90>
80104012:	3b 50 20             	cmp    0x20(%eax),%edx
80104015:	75 e9                	jne    80104000 <exit+0x90>
      p->state = RUNNABLE;
80104017:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010401e:	05 a0 00 00 00       	add    $0xa0,%eax
80104023:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80104028:	75 e2                	jne    8010400c <exit+0x9c>
      p->parent = initproc;
8010402a:	8b 0d 58 b6 10 80    	mov    0x8010b658,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104030:	ba 34 47 11 80       	mov    $0x80114734,%edx
80104035:	eb 17                	jmp    8010404e <exit+0xde>
80104037:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010403e:	66 90                	xchg   %ax,%ax
80104040:	81 c2 a0 00 00 00    	add    $0xa0,%edx
80104046:	81 fa 34 6f 11 80    	cmp    $0x80116f34,%edx
8010404c:	74 3a                	je     80104088 <exit+0x118>
    if(p->parent == curproc){
8010404e:	39 72 14             	cmp    %esi,0x14(%edx)
80104051:	75 ed                	jne    80104040 <exit+0xd0>
      if(p->state == ZOMBIE)
80104053:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80104057:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
8010405a:	75 e4                	jne    80104040 <exit+0xd0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010405c:	b8 34 47 11 80       	mov    $0x80114734,%eax
80104061:	eb 11                	jmp    80104074 <exit+0x104>
80104063:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104067:	90                   	nop
80104068:	05 a0 00 00 00       	add    $0xa0,%eax
8010406d:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80104072:	74 cc                	je     80104040 <exit+0xd0>
    if(p->state == SLEEPING && p->chan == chan) {
...
80104086:	eb e0                	jmp    80104068 <exit+0xf8>
  curproc->state = ZOMBIE;
80104088:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
8010408f:	e8 1c fe ff ff       	call   80103eb0 <sched>
  panic("zombie exit");
80104094:	83 ec 0c             	sub    $0xc,%esp
80104097:	68 e3 84 10 80       	push   $0x801084e3
8010409c:	e8 ef c2 ff ff       	call   80100390 <panic>
    panic("init exiting");
801040a1:	83 ec 0c             	sub    $0xc,%esp
801040a4:	68 d6 84 10 80       	push   $0x801084d6
801040a9:	e8 e2 c2 ff ff       	call   80100390 <panic>
...
801040bb:	68 00 47 11 80       	push   $0x80114700
801040c0:	e8 fb 0a 00 00       	call   80104bc0 <acquire>
  pushcli();
801040c5:	e8 f6 09 00 00       	call   80104ac0 <pushcli>
  c = mycpu();
801040ca:	e8 11 f8 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
801040cf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040d5:	e8 36 0a 00 00       	call   80104b10 <popcli>
  myproc()->state = RUNNABLE;
801040da:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
801040e1:	e8 ca fd ff ff       	call   80103eb0 <sched>
  release(&ptable.lock);
801040e6:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
801040ed:	e8 8e 0b 00 00       	call   80104c80 <release>
}
...
8010410d:	8b 7d 08             	mov    0x8(%ebp),%edi
80104110:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80104113:	e8 a8 09 00 00       	call   80104ac0 <pushcli>
  c = mycpu();
80104118:	e8 c3 f7 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
8010411d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104123:	e8 e8 09 00 00       	call   80104b10 <popcli>
  if(p == 0)
80104128:	85 db                	test   %ebx,%ebx
8010412a:	0f 84 83 00 00 00    	je     801041b3 <sleep+0xb3>
  if(lk == 0)
80104130:	85 f6                	test   %esi,%esi
80104132:	74 72                	je     801041a6 <sleep+0xa6>
  if(lk != &ptable.lock){  //DOC: sleeplock0
80104134:	81 fe 00 47 11 80    	cmp    $0x80114700,%esi
8010413a:	74 4c                	je     80104188 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
8010413c:	83 ec 0c             	sub    $0xc,%esp
8010413f:	68 00 47 11 80       	push   $0x80114700
80104144:	e8 77 0a 00 00       	call   80104bc0 <acquire>
    release(lk);
80104149:	89 34 24             	mov    %esi,(%esp)
8010414c:	e8 2f 0b 00 00       	call   80104c80 <release>
  p->chan = chan;
80104151:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80104154:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
8010415b:	e8 50 fd ff ff       	call   80103eb0 <sched>
  p->chan = 0;
80104160:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80104167:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
8010416e:	e8 0d 0b 00 00       	call   80104c80 <release>
    acquire(lk);
80104173:	89 75 08             	mov    %esi,0x8(%ebp)
80104176:	83 c4 10             	add    $0x10,%esp
}
80104179:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010417c:	5b                   	pop    %ebx
8010417d:	5e                   	pop    %esi
8010417e:	5f                   	pop    %edi
8010417f:	5d                   	pop    %ebp
    acquire(lk);
80104180:	e9 3b 0a 00 00       	jmp    80104bc0 <acquire>
...
8010418b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104192:	e8 19 fd ff ff       	call   80103eb0 <sched>
  p->chan = 0;
...
801041a9:	68 ef 84 10 80       	push   $0x801084ef
801041ae:	e8 dd c1 ff ff       	call   80100390 <panic>
    panic("sleep");
801041b3:	83 ec 0c             	sub    $0xc,%esp
801041b6:	68 87 87 10 80       	push   $0x80108787
...
801041c8:	53                   	push   %ebx
  pushcli();
801041c9:	e8 f2 08 00 00       	call   80104ac0 <pushcli>
  c = mycpu();
801041ce:	e8 0d f7 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
801041d3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801041d9:	e8 32 09 00 00       	call   80104b10 <popcli>
  acquire(&ptable.lock);
801041de:	83 ec 0c             	sub    $0xc,%esp
801041e1:	68 00 47 11 80       	push   $0x80114700
801041e6:	e8 d5 09 00 00       	call   80104bc0 <acquire>
801041eb:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801041ee:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041f0:	bb 34 47 11 80       	mov    $0x80114734,%ebx
801041f5:	eb 17                	jmp    8010420e <wait+0x4e>
801041f7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801041fe:	66 90                	xchg   %ax,%ax
80104200:	81 c3 a0 00 00 00    	add    $0xa0,%ebx
80104206:	81 fb 34 6f 11 80    	cmp    $0x80116f34,%ebx
8010420c:	74 1e                	je     8010422c <wait+0x6c>
      if(p->parent != curproc)
8010420e:	39 73 14             	cmp    %esi,0x14(%ebx)
80104211:	75 ed                	jne    80104200 <wait+0x40>
      if(p->state == ZOMBIE){
80104213:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104217:	74 37                	je     80104250 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104219:	81 c3 a0 00 00 00    	add    $0xa0,%ebx
      havekids = 1;
8010421f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104224:	81 fb 34 6f 11 80    	cmp    $0x80116f34,%ebx
8010422a:	75 e2                	jne    8010420e <wait+0x4e>
    if(!havekids || curproc->killed){
8010422c:	85 c0                	test   %eax,%eax
8010422e:	74 76                	je     801042a6 <wait+0xe6>
80104230:	8b 46 24             	mov    0x24(%esi),%eax
80104233:	85 c0                	test   %eax,%eax
80104235:	75 6f                	jne    801042a6 <wait+0xe6>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80104237:	83 ec 08             	sub    $0x8,%esp
8010423a:	68 00 47 11 80       	push   $0x80114700
8010423f:	56                   	push   %esi
80104240:	e8 bb fe ff ff       	call   80104100 <sleep>
    havekids = 0;
80104245:	83 c4 10             	add    $0x10,%esp
80104248:	eb a4                	jmp    801041ee <wait+0x2e>
...
80104256:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104259:	e8 12 e2 ff ff       	call   80102470 <kfree>
        freevm(p->pgdir);
8010425e:	5a                   	pop    %edx
...
80104262:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104269:	e8 22 39 00 00       	call   80107b90 <freevm>
        release(&ptable.lock);
8010426e:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
        p->pid = 0;
...
8010428e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104295:	e8 e6 09 00 00       	call   80104c80 <release>
        return pid;
...
801042a9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801042ae:	68 00 47 11 80       	push   $0x80114700
801042b3:	e8 c8 09 00 00       	call   80104c80 <release>
      return -1;
801042b8:	83 c4 10             	add    $0x10,%esp
801042bb:	eb e0                	jmp    8010429d <wait+0xdd>
...
801042cb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801042ce:	68 00 47 11 80       	push   $0x80114700
801042d3:	e8 e8 08 00 00       	call   80104bc0 <acquire>
801042d8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042db:	b8 34 47 11 80       	mov    $0x80114734,%eax
801042e0:	eb 12                	jmp    801042f4 <wakeup+0x34>
801042e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801042e8:	05 a0 00 00 00       	add    $0xa0,%eax
801042ed:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
801042f2:	74 1e                	je     80104312 <wakeup+0x52>
    if(p->state == SLEEPING && p->chan == chan) {
801042f4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801042f8:	75 ee                	jne    801042e8 <wakeup+0x28>
801042fa:	3b 58 20             	cmp    0x20(%eax),%ebx
801042fd:	75 e9                	jne    801042e8 <wakeup+0x28>
      p->state = RUNNABLE;
801042ff:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104306:	05 a0 00 00 00       	add    $0xa0,%eax
8010430b:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80104310:	75 e2                	jne    801042f4 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
80104312:	c7 45 08 00 47 11 80 	movl   $0x80114700,0x8(%ebp)
}
80104319:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010431c:	c9                   	leave  
  release(&ptable.lock);
8010431d:	e9 5e 09 00 00       	jmp    80104c80 <release>
...
8010433b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010433e:	68 00 47 11 80       	push   $0x80114700
80104343:	e8 78 08 00 00       	call   80104bc0 <acquire>
80104348:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010434b:	b8 34 47 11 80       	mov    $0x80114734,%eax
80104350:	eb 12                	jmp    80104364 <kill+0x34>
80104352:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104358:	05 a0 00 00 00       	add    $0xa0,%eax
8010435d:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80104362:	74 34                	je     80104398 <kill+0x68>
    if(p->pid == pid){
...
8010436d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING) {
80104374:	75 07                	jne    8010437d <kill+0x4d>
        p->state = RUNNABLE;
80104376:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
        // process_state.state[p->index]  = RUNNABLE;   //a2
      }
        
      release(&ptable.lock);
8010437d:	83 ec 0c             	sub    $0xc,%esp
80104380:	68 00 47 11 80       	push   $0x80114700
80104385:	e8 f6 08 00 00       	call   80104c80 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801043a0:	e8 db 08 00 00       	call   80104c80 <release>
}
...
801043cd:	bb a0 47 11 80       	mov    $0x801147a0,%ebx
...
801043e3:	68 36 85 10 80       	push   $0x80108536
801043e8:	e8 c3 c2 ff ff       	call   801006b0 <cprintf>
801043ed:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043f0:	81 c3 a0 00 00 00    	add    $0xa0,%ebx
801043f6:	81 fb a0 6f 11 80    	cmp    $0x80116fa0,%ebx
...
80104407:	74 e7                	je     801043f0 <procdump+0x30>
      state = "???";
80104409:	ba 00 85 10 80       	mov    $0x80108500,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010440e:	83 f8 05             	cmp    $0x5,%eax
80104411:	77 11                	ja     80104424 <procdump+0x64>
80104413:	8b 14 85 8c 85 10 80 	mov    -0x7fef7a74(,%eax,4),%edx
      state = "???";
8010441a:	b8 00 85 10 80       	mov    $0x80108500,%eax
...
80104429:	68 04 85 10 80       	push   $0x80108504
...
80104450:	e8 0b 06 00 00       	call   80104a60 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104471:	68 61 7f 10 80       	push   $0x80107f61
...
801044a8:	bb a0 47 11 80       	mov    $0x801147a0,%ebx
801044ad:	83 ec 10             	sub    $0x10,%esp
  struct proc *p;
  acquire(&ptable.lock);
801044b0:	68 00 47 11 80       	push   $0x80114700
801044b5:	e8 06 07 00 00       	call   80104bc0 <acquire>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801044ba:	83 c4 10             	add    $0x10,%esp
801044bd:	8d 76 00             	lea    0x0(%esi),%esi
      if (p->state == UNUSED)
801044c0:	8b 43 a0             	mov    -0x60(%ebx),%eax
801044c3:	85 c0                	test   %eax,%eax
801044c5:	74 14                	je     801044db <ps+0x3b>
        continue;
      cprintf("pid:%d name:%s\n", p->pid, p->name);
801044c7:	83 ec 04             	sub    $0x4,%esp
801044ca:	53                   	push   %ebx
801044cb:	ff 73 a4             	pushl  -0x5c(%ebx)
801044ce:	68 0d 85 10 80       	push   $0x8010850d
801044d3:	e8 d8 c1 ff ff       	call   801006b0 <cprintf>
801044d8:	83 c4 10             	add    $0x10,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801044db:	81 c3 a0 00 00 00    	add    $0xa0,%ebx
801044e1:	81 fb a0 6f 11 80    	cmp    $0x80116fa0,%ebx
801044e7:	75 d7                	jne    801044c0 <ps+0x20>
    }
  release(&ptable.lock);
801044e9:	83 ec 0c             	sub    $0xc,%esp
801044ec:	68 00 47 11 80       	push   $0x80114700
801044f1:	e8 8a 07 00 00       	call   80104c80 <release>
  return 0;
}
801044f6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801044f9:	31 c0                	xor    %eax,%eax
801044fb:	c9                   	leave  
801044fc:	c3                   	ret    
...
80104509:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010450c:	e8 af 05 00 00       	call   80104ac0 <pushcli>
  c = mycpu();
80104511:	e8 ca f3 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80104516:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
8010451c:	e8 ef 05 00 00       	call   80104b10 <popcli>
  struct proc *p = myproc();
  if(lk != &ptable.lock) {
80104521:	81 fb 00 47 11 80    	cmp    $0x80114700,%ebx
80104527:	74 47                	je     80104570 <block+0x70>
    acquire(&ptable.lock);
80104529:	83 ec 0c             	sub    $0xc,%esp
8010452c:	68 00 47 11 80       	push   $0x80114700
80104531:	e8 8a 06 00 00       	call   80104bc0 <acquire>
    release(lk);
80104536:	89 1c 24             	mov    %ebx,(%esp)
80104539:	e8 42 07 00 00       	call   80104c80 <release>
  }
  p->state = SLEEPING;
8010453e:	c7 46 0c 02 00 00 00 	movl   $0x2,0xc(%esi)
  sched();
80104545:	e8 66 f9 ff ff       	call   80103eb0 <sched>
  if(lk != &ptable.lock) {
    release(&ptable.lock);
8010454a:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
80104551:	e8 2a 07 00 00       	call   80104c80 <release>
    acquire(lk);
80104556:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80104561:	5d                   	pop    %ebp
    acquire(lk);
80104562:	e9 59 06 00 00       	jmp    80104bc0 <acquire>
80104567:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010456e:	66 90                	xchg   %ax,%ax
  p->state = SLEEPING;
80104570:	c7 46 0c 02 00 00 00 	movl   $0x2,0xc(%esi)
}
...
8010457c:	5d                   	pop    %ebp
  sched();
8010457d:	e9 2e f9 ff ff       	jmp    80103eb0 <sched>
...
8010459b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;
  acquire(&ptable.lock);
8010459e:	68 00 47 11 80       	push   $0x80114700
801045a3:	e8 18 06 00 00       	call   80104bc0 <acquire>
801045a8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801045ab:	b8 34 47 11 80       	mov    $0x80114734,%eax
801045b0:	eb 12                	jmp    801045c4 <unblock+0x34>
801045b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801045b8:	05 a0 00 00 00       	add    $0xa0,%eax
801045bd:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
801045c2:	74 2c                	je     801045f0 <unblock+0x60>
    if(p->pid == pid){
801045c4:	39 58 10             	cmp    %ebx,0x10(%eax)
801045c7:	75 ef                	jne    801045b8 <unblock+0x28>
      if(p->state == SLEEPING)
801045c9:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801045cd:	75 07                	jne    801045d6 <unblock+0x46>
        p->state = RUNNABLE;
801045cf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
801045d6:	c7 45 08 00 47 11 80 	movl   $0x80114700,0x8(%ebp)
      return;
    }
  }
}
...
801045e0:	c9                   	leave  
      release(&ptable.lock);
801045e1:	e9 9a 06 00 00       	jmp    80104c80 <release>
...
80104600 <time_ticks_update>:


void time_ticks_update() {        //a2
...
80104607:	83 ec 14             	sub    $0x14,%esp
  struct proc *p;
  acquire(&ptable.lock);
8010460a:	68 00 47 11 80       	push   $0x80114700
8010460f:	e8 ac 05 00 00       	call   80104bc0 <acquire>
80104614:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104617:	b8 34 47 11 80       	mov    $0x80114734,%eax
8010461c:	eb 1a                	jmp    80104638 <time_ticks_update+0x38>
8010461e:	66 90                	xchg   %ax,%ax
    switch(p->state) {
80104620:	83 fa 04             	cmp    $0x4,%edx
80104623:	75 07                	jne    8010462c <time_ticks_update+0x2c>
      //   break;
      case RUNNABLE:
        p->wait_time++;
        break;
      case RUNNING:
        p->elapsed_time++;
80104625:	83 80 90 00 00 00 01 	addl   $0x1,0x90(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010462c:	05 a0 00 00 00       	add    $0xa0,%eax
80104631:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80104636:	74 1b                	je     80104653 <time_ticks_update+0x53>
    switch(p->state) {
80104638:	8b 50 0c             	mov    0xc(%eax),%edx
8010463b:	83 fa 03             	cmp    $0x3,%edx
8010463e:	75 e0                	jne    80104620 <time_ticks_update+0x20>
        p->wait_time++;
80104640:	83 80 94 00 00 00 01 	addl   $0x1,0x94(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104647:	05 a0 00 00 00       	add    $0xa0,%eax
8010464c:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80104651:	75 e5                	jne    80104638 <time_ticks_update+0x38>
        break;
      default:
        ;
    }
...
80104656:	68 00 47 11 80       	push   $0x80114700
8010465b:	e8 20 06 00 00       	call   80104c80 <release>
}
...
8010467b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;
  acquire(&ptable.lock);
8010467e:	68 00 47 11 80       	push   $0x80114700
80104683:	e8 38 05 00 00       	call   80104bc0 <acquire>
80104688:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010468b:	b8 34 47 11 80       	mov    $0x80114734,%eax
80104690:	eb 12                	jmp    801046a4 <__exec_time+0x34>
80104692:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104698:	05 a0 00 00 00       	add    $0xa0,%eax
8010469d:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
801046a2:	74 2c                	je     801046d0 <__exec_time+0x60>
    if(p->pid == pid){
801046a4:	39 58 10             	cmp    %ebx,0x10(%eax)
801046a7:	75 ef                	jne    80104698 <__exec_time+0x28>
      p->execution_time = time;
801046a9:	8b 55 0c             	mov    0xc(%ebp),%edx
      release(&ptable.lock);
801046ac:	83 ec 0c             	sub    $0xc,%esp
      p->execution_time = time;
801046af:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
      release(&ptable.lock);
801046b5:	68 00 47 11 80       	push   $0x80114700
801046ba:	e8 c1 05 00 00       	call   80104c80 <release>
      return 0;
    }
  }
...
801046d0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  return -22;
801046d3:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
} 
801046d8:	c9                   	leave  
801046d9:	c3                   	ret    
...
801046eb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;
  acquire(&ptable.lock);
801046ee:	68 00 47 11 80       	push   $0x80114700
801046f3:	e8 c8 04 00 00       	call   80104bc0 <acquire>
801046f8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046fb:	b8 34 47 11 80       	mov    $0x80114734,%eax
80104700:	eb 12                	jmp    80104714 <__deadline+0x34>
80104702:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104708:	05 a0 00 00 00       	add    $0xa0,%eax
8010470d:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80104712:	74 2c                	je     80104740 <__deadline+0x60>
    if(p->pid == pid){
80104714:	39 58 10             	cmp    %ebx,0x10(%eax)
80104717:	75 ef                	jne    80104708 <__deadline+0x28>
      p->deadline = deadtime + p->arrival;
80104719:	8b 55 0c             	mov    0xc(%ebp),%edx
      release(&ptable.lock);
8010471c:	83 ec 0c             	sub    $0xc,%esp
      p->deadline = deadtime + p->arrival;
8010471f:	03 90 9c 00 00 00    	add    0x9c(%eax),%edx
80104725:	89 90 98 00 00 00    	mov    %edx,0x98(%eax)
      release(&ptable.lock);
8010472b:	68 00 47 11 80       	push   $0x80114700
80104730:	e8 4b 05 00 00       	call   80104c80 <release>
      return 0;
    }
  }
...
80104740:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  return -22;
80104743:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
} 
80104748:	c9                   	leave  
80104749:	c3                   	ret    
...
80104762:	68 00 47 11 80       	push   $0x80114700
80104767:	e8 54 04 00 00       	call   80104bc0 <acquire>
8010476c:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010476f:	b9 34 47 11 80       	mov    $0x80114734,%ecx
80104774:	eb 18                	jmp    8010478e <__rate+0x3e>
80104776:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010477d:	8d 76 00             	lea    0x0(%esi),%esi
80104780:	81 c1 a0 00 00 00    	add    $0xa0,%ecx
80104786:	81 f9 34 6f 11 80    	cmp    $0x80116f34,%ecx
8010478c:	74 6a                	je     801047f8 <__rate+0xa8>
    if(p->pid == pid){
8010478e:	39 59 10             	cmp    %ebx,0x10(%ecx)
80104791:	75 ed                	jne    80104780 <__rate+0x30>
      p->rate = rate;
      int prio;
      if ((30 - rate) % 29 == 0) {
80104793:	bb 1e 00 00 00       	mov    $0x1e,%ebx
      p->rate = rate;
80104798:	89 b1 88 00 00 00    	mov    %esi,0x88(%ecx)
      if ((30 - rate) % 29 == 0) {
8010479e:	ba 09 cb 3d 8d       	mov    $0x8d3dcb09,%edx
801047a3:	29 f3                	sub    %esi,%ebx
801047a5:	8d 34 5b             	lea    (%ebx,%ebx,2),%esi
801047a8:	89 f0                	mov    %esi,%eax
801047aa:	69 db 35 c2 72 4f    	imul   $0x4f72c235,%ebx,%ebx
801047b0:	f7 ea                	imul   %edx
      } else {
        prio = (30 - rate) * 3/ 29;
        prio++;
      }
      if(prio < 1) prio = 1;
      p->weight = prio;
801047b2:	b8 01 00 00 00       	mov    $0x1,%eax
801047b7:	81 c3 58 ee 69 04    	add    $0x469ee58,%ebx
801047bd:	01 f2                	add    %esi,%edx
801047bf:	c1 fe 1f             	sar    $0x1f,%esi
801047c2:	c1 fa 04             	sar    $0x4,%edx
801047c5:	29 f2                	sub    %esi,%edx
        prio++;
801047c7:	81 fb b1 dc d3 08    	cmp    $0x8d3dcb1,%ebx
801047cd:	83 da ff             	sbb    $0xffffffff,%edx
      p->weight = prio;
801047d0:	85 d2                	test   %edx,%edx
801047d2:	0f 4e d0             	cmovle %eax,%edx
      release(&ptable.lock);
801047d5:	83 ec 0c             	sub    $0xc,%esp
      p->weight = prio;
801047d8:	89 91 84 00 00 00    	mov    %edx,0x84(%ecx)
      release(&ptable.lock);
801047de:	68 00 47 11 80       	push   $0x80114700
801047e3:	e8 98 04 00 00       	call   80104c80 <release>
      return 0;
...
801047f8:	8d 65 f8             	lea    -0x8(%ebp),%esp
  return -22;
801047fb:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
} 
80104800:	5b                   	pop    %ebx
80104801:	5e                   	pop    %esi
80104802:	5d                   	pop    %ebp
...
80104818:	83 ec 20             	sub    $0x20,%esp
8010481b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;
  acquire(&ptable.lock);
8010481e:	68 00 47 11 80       	push   $0x80114700
80104823:	e8 98 03 00 00       	call   80104bc0 <acquire>
80104828:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010482b:	b8 34 47 11 80       	mov    $0x80114734,%eax
80104830:	eb 12                	jmp    80104844 <__policy+0x34>
80104832:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104838:	05 a0 00 00 00       	add    $0xa0,%eax
8010483d:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
80104842:	74 0e                	je     80104852 <__policy+0x42>
    if(p->pid == pid){
80104844:	39 58 10             	cmp    %ebx,0x10(%eax)
80104847:	75 ef                	jne    80104838 <__policy+0x28>
      p->sched_policy = policy;
80104849:	8b 55 0c             	mov    0xc(%ebp),%edx
8010484c:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
    }
  }
...
80104854:	31 db                	xor    %ebx,%ebx
  ...
  // acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104856:	b8 34 47 11 80       	mov    $0x80114734,%eax
8010485b:	eb 0f                	jmp    8010486c <__policy+0x5c>
8010485d:	8d 76 00             	lea    0x0(%esi),%esi
80104860:	05 a0 00 00 00       	add    $0xa0,%eax
80104865:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
8010486a:	74 40                	je     801048ac <__policy+0x9c>
    if (p->state == RUNNABLE || p->state == RUNNING) {
8010486c:	8b 48 0c             	mov    0xc(%eax),%ecx
8010486f:	8d 51 fd             	lea    -0x3(%ecx),%edx
80104872:	83 fa 01             	cmp    $0x1,%edx
80104875:	77 e9                	ja     80104860 <__policy+0x50>
      ++n;
...
80104877:	8b 90 98 00 00 00    	mov    0x98(%eax),%edx
      U_rms += (1.0 * (p->rate) * (p->execution_time)) / (100.0);
8010487d:	8b 88 8c 00 00 00    	mov    0x8c(%eax),%ecx
      ++n;
80104883:	83 c3 01             	add    $0x1,%ebx
      if(p->deadline != 0) U_edf += (1.0 * (p->execution_time)) / (p->deadline);
80104886:	85 d2                	test   %edx,%edx
80104888:	74 d6                	je     80104860 <__policy+0x50>
      U_rms += (1.0 * (p->rate) * (p->execution_time)) / (100.0);
8010488a:	89 4d f0             	mov    %ecx,-0x10(%ebp)
8010488d:	db 45 f0             	fildl  -0x10(%ebp)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104890:	05 a0 00 00 00       	add    $0xa0,%eax
      if(p->deadline != 0) U_edf += (1.0 * (p->execution_time)) / (p->deadline);
80104895:	89 55 f0             	mov    %edx,-0x10(%ebp)
80104898:	db 45 f0             	fildl  -0x10(%ebp)
8010489b:	de f9                	fdivrp %st,%st(1)
8010489d:	de c1                	faddp  %st,%st(1)
8010489f:	d9 5d f0             	fstps  -0x10(%ebp)
801048a2:	d9 45 f0             	flds   -0x10(%ebp)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048a5:	3d 34 6f 11 80       	cmp    $0x80116f34,%eax
801048aa:	75 c0                	jne    8010486c <__policy+0x5c>
    }
  }
  int beg_edf = (int)(U_edf);
801048ac:	d9 7d f6             	fnstcw -0xa(%ebp)
801048af:	0f b7 45 f6          	movzwl -0xa(%ebp),%eax
801048b3:	80 cc 0c             	or     $0xc,%ah
801048b6:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
801048ba:	d9 6d f4             	fldcw  -0xc(%ebp)
801048bd:	db 55 f0             	fistl  -0x10(%ebp)
801048c0:	d9 6d f6             	fldcw  -0xa(%ebp)
801048c3:	8b 55 f0             	mov    -0x10(%ebp),%edx
  int fin_edf = (int)(U_edf * 100)- beg_edf * 100;
801048c6:	d8 0d a4 85 10 80    	fmuls  0x801085a4
801048cc:	d9 6d f4             	fldcw  -0xc(%ebp)
801048cf:	db 5d f0             	fistpl -0x10(%ebp)
801048d2:	d9 6d f6             	fldcw  -0xa(%ebp)
801048d5:	6b ca 9c             	imul   $0xffffff9c,%edx,%ecx
801048d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801048db:	01 c8                	add    %ecx,%eax
  // printf(1, "Variance of array for the file arr is %d.%d \n", beg, fin);
  cprintf("n = %d and U_edf = %d.%d \n", n, beg_edf, fin_edf);
801048dd:	50                   	push   %eax
801048de:	52                   	push   %edx
801048df:	53                   	push   %ebx
801048e0:	68 1d 85 10 80       	push   $0x8010851d
801048e5:	e8 c6 bd ff ff       	call   801006b0 <cprintf>
  // cprintf("n = %d and U_rms = %d \n", n, U_rms);
  release(&ptable.lock);
801048ea:	c7 04 24 00 47 11 80 	movl   $0x80114700,(%esp)
801048f1:	e8 8a 03 00 00       	call   80104c80 <release>
...
8010490e:	68 a8 85 10 80       	push   $0x801085a8
...
8010496d:	e8 8e f7 ff ff       	call   80104100 <sleep>
  while (lk->locked) {
...
8010497b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104981:	e8 ea ef ff ff       	call   80103970 <myproc>
...
801049c8:	e8 f3 f8 ff ff       	call   801042c0 <wakeup>
  release(&lk->lk);
...
80104a23:	e8 48 ef ff ff       	call   80103970 <myproc>
...
80104aef:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
80104af0:	e8 eb ed ff ff       	call   801038e0 <mycpu>
...
80104b3f:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104b40:	e8 9b ed ff ff       	call   801038e0 <mycpu>
...
80104b55:	68 b3 85 10 80       	push   $0x801085b3
80104b5a:	e8 31 b8 ff ff       	call   80100390 <panic>
    panic("popcli");
80104b5f:	83 ec 0c             	sub    $0xc,%esp
80104b62:	68 ca 85 10 80       	push   $0x801085ca
...
80104b9b:	e8 40 ed ff ff       	call   801038e0 <mycpu>
...
80104c04:	e8 d7 ec ff ff       	call   801038e0 <mycpu>
...
80104c67:	68 d1 85 10 80       	push   $0x801085d1
...
80104cc0:	68 d9 85 10 80       	push   $0x801085d9
80104cc5:	e8 c6 b6 ff ff       	call   80100390 <panic>
...
80104f15:	bb 80 9c 11 80       	mov    $0x80119c80,%ebx
...
80104f24:	83 c3 08             	add    $0x8,%ebx
80104f27:	e8 74 2f 00 00       	call   80107ea0 <setup>
    for(int i = 0; i < NPROC; i++) {
80104f2c:	83 c4 10             	add    $0x10,%esp
80104f2f:	81 fb 80 9e 11 80    	cmp    $0x80119e80,%ebx
80104f35:	75 e9                	jne    80104f20 <initialise.part.0+0x10>
80104f37:	bb 80 8f 11 80       	mov    $0x80118f80,%ebx
80104f3c:	be 80 9c 11 80       	mov    $0x80119c80,%esi
80104f41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    }
    for(int i = 0; i < NPROC; i++) {
      initlock(&(msgQueue_locks[i]),"msgQueue_locks");
80104f48:	83 ec 08             	sub    $0x8,%esp
80104f4b:	68 e1 85 10 80       	push   $0x801085e1
80104f50:	53                   	push   %ebx
80104f51:	83 c3 34             	add    $0x34,%ebx
80104f54:	e8 e7 fa ff ff       	call   80104a40 <initlock>
      initlock(&buffer_lock,"buffer_lock");
80104f59:	58                   	pop    %eax
80104f5a:	5a                   	pop    %edx
80104f5b:	68 f0 85 10 80       	push   $0x801085f0
80104f60:	68 40 8f 11 80       	push   $0x80118f40
80104f65:	e8 d6 fa ff ff       	call   80104a40 <initlock>
    for(int i = 0; i < NPROC; i++) {
80104f6a:	83 c4 10             	add    $0x10,%esp
80104f6d:	39 de                	cmp    %ebx,%esi
80104f6f:	75 d7                	jne    80104f48 <initialise.part.0+0x38>
    }
    setupp = 1;
80104f71:	c7 05 60 b6 10 80 01 	movl   $0x1,0x8010b660
80104f78:	00 00 00 
  } 
  return 0;
}
80104f7b:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104f7e:	5b                   	pop    %ebx
80104f7f:	5e                   	pop    %esi
80104f80:	5d                   	pop    %ebp
80104f81:	c3                   	ret    
...
80104f9b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104f9e:	e8 cd e9 ff ff       	call   80103970 <myproc>
...
80104fdb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104fde:	e8 8d e9 ff ff       	call   80103970 <myproc>
  if(addr >= curproc->sz)
...
80105039:	e8 32 e9 ff ff       	call   80103970 <myproc>
...
80105047:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
8010504a:	e8 21 e9 ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
8010508c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  struct proc *curproc = myproc();
8010508f:	e8 dc e8 ff ff       	call   80103970 <myproc>
  if(argint(n, &i) < 0)
...
801050ea:	83 ec 1c             	sub    $0x1c,%esp
  if(setupp == 0) {
801050ed:	a1 60 b6 10 80       	mov    0x8010b660,%eax
801050f2:	85 c0                	test   %eax,%eax
801050f4:	75 05                	jne    801050fb <sys_send+0x1b>
801050f6:	e8 15 fe ff ff       	call   80104f10 <initialise.part.0>
  int rec_pid;
  void* msg;
...
801050fe:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105101:	50                   	push   %eax
80105102:	6a 00                	push   $0x0
80105104:	e8 27 ff ff ff       	call   80105030 <argint>
...
8010510b:	89 c6                	mov    %eax,%esi
  int y = argint(1,&rec_pid);
8010510d:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105110:	50                   	push   %eax
80105111:	6a 01                	push   $0x1
80105113:	e8 18 ff ff ff       	call   80105030 <argint>
  int z = argptr(2,(void*)&msg, sizeof(void*));
80105118:	83 c4 0c             	add    $0xc,%esp
  int y = argint(1,&rec_pid);
8010511b:	89 c3                	mov    %eax,%ebx
  int z = argptr(2,(void*)&msg, sizeof(void*));
8010511d:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105120:	6a 04                	push   $0x4
80105122:	50                   	push   %eax

  if (x < 0 || y < 0 || z < 0) {  // some error in extraction
80105123:	c1 eb 1f             	shr    $0x1f,%ebx
  int z = argptr(2,(void*)&msg, sizeof(void*));
80105126:	6a 02                	push   $0x2
80105128:	e8 53 ff ff ff       	call   80105080 <argptr>
  if (x < 0 || y < 0 || z < 0) {  // some error in extraction
8010512d:	83 c4 10             	add    $0x10,%esp
  int z = argptr(2,(void*)&msg, sizeof(void*));
80105130:	89 c2                	mov    %eax,%edx
  if (x < 0 || y < 0 || z < 0) {  // some error in extraction
80105132:	89 f0                	mov    %esi,%eax
80105134:	c1 e8 1f             	shr    $0x1f,%eax
80105137:	08 d8                	or     %bl,%al
80105139:	0f 85 d0 00 00 00    	jne    8010520f <sys_send+0x12f>
8010513f:	85 d2                	test   %edx,%edx
80105141:	0f 88 c8 00 00 00    	js     8010520f <sys_send+0x12f>
  }
...
8010514a:	31 db                	xor    %ebx,%ebx
  acquire(&buffer_lock);
8010514c:	68 40 8f 11 80       	push   $0x80118f40
80105151:	e8 6a fa ff ff       	call   80104bc0 <acquire>
80105156:	83 c4 10             	add    $0x10,%esp
80105159:	eb 14                	jmp    8010516f <sys_send+0x8f>
8010515b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010515f:	90                   	nop
  for(int i=0; i < NELEM(msg_buffer); i++) {
80105160:	83 c3 01             	add    $0x1,%ebx
80105163:	81 fb 00 02 00 00    	cmp    $0x200,%ebx
80105169:	0f 84 94 00 00 00    	je     80105203 <sys_send+0x123>
    if(allocated[i] == 0) {
8010516f:	8b 34 9d 80 b6 10 80 	mov    -0x7fef4980(,%ebx,4),%esi
80105176:	85 f6                	test   %esi,%esi
80105178:	75 e6                	jne    80105160 <sys_send+0x80>
      allocated[i] = 1;
8010517a:	c7 04 9d 80 b6 10 80 	movl   $0x1,-0x7fef4980(,%ebx,4)
80105181:	01 00 00 00 
      release(&buffer_lock);
80105185:	83 ec 0c             	sub    $0xc,%esp
      final = &msg_buffer[i];
80105188:	89 df                	mov    %ebx,%edi
      release(&buffer_lock);
8010518a:	68 40 8f 11 80       	push   $0x80118f40
      final = &msg_buffer[i];
8010518f:	c1 e7 04             	shl    $0x4,%edi
      release(&buffer_lock);
80105192:	e8 e9 fa ff ff       	call   80104c80 <release>
      
      final->bp = i;
      memmove(final->msg,msg,8);
80105197:	83 c4 0c             	add    $0xc,%esp
      final->bp = i;
8010519a:	89 9f 48 6f 11 80    	mov    %ebx,-0x7fee90b8(%edi)
      final = &msg_buffer[i];
801051a0:	81 c7 40 6f 11 80    	add    $0x80116f40,%edi
      memmove(final->msg,msg,8);
801051a6:	6a 08                	push   $0x8
801051a8:	ff 75 e4             	pushl  -0x1c(%ebp)
801051ab:	57                   	push   %edi
801051ac:	e8 bf fb ff ff       	call   80104d70 <memmove>
      final->next = 0;

      acquire(&msgQueue_locks[rec_pid]);
801051b1:	6b 45 e0 34          	imul   $0x34,-0x20(%ebp),%eax
      final->next = 0;
801051b5:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
      acquire(&msgQueue_locks[rec_pid]);
801051bc:	05 80 8f 11 80       	add    $0x80118f80,%eax
801051c1:	89 04 24             	mov    %eax,(%esp)
801051c4:	e8 f7 f9 ff ff       	call   80104bc0 <acquire>
      add_in_queue(final, &QQ[rec_pid]);  // inserted in the receiver's queue
801051c9:	58                   	pop    %eax
801051ca:	8b 45 e0             	mov    -0x20(%ebp),%eax
801051cd:	5a                   	pop    %edx
801051ce:	8d 04 c5 80 9c 11 80 	lea    -0x7fee6380(,%eax,8),%eax
801051d5:	50                   	push   %eax
801051d6:	57                   	push   %edi
801051d7:	e8 e4 2c 00 00       	call   80107ec0 <add_in_queue>
      unblock(rec_pid);
801051dc:	59                   	pop    %ecx
801051dd:	ff 75 e0             	pushl  -0x20(%ebp)
801051e0:	e8 ab f3 ff ff       	call   80104590 <unblock>
      release(&msgQueue_locks[rec_pid]);
801051e5:	6b 45 e0 34          	imul   $0x34,-0x20(%ebp),%eax
801051e9:	05 80 8f 11 80       	add    $0x80118f80,%eax
801051ee:	89 04 24             	mov    %eax,(%esp)
801051f1:	e8 8a fa ff ff       	call   80104c80 <release>
      return 0;
...
801051f9:	8d 65 f4             	lea    -0xc(%ebp),%esp
801051fc:	89 f0                	mov    %esi,%eax
801051fe:	5b                   	pop    %ebx
801051ff:	5e                   	pop    %esi
80105200:	5f                   	pop    %edi
80105201:	5d                   	pop    %ebp
80105202:	c3                   	ret    
80105203:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
80105206:	31 f6                	xor    %esi,%esi
}
80105208:	5b                   	pop    %ebx
80105209:	89 f0                	mov    %esi,%eax
8010520b:	5e                   	pop    %esi
8010520c:	5f                   	pop    %edi
8010520d:	5d                   	pop    %ebp
8010520e:	c3                   	ret    
    return -1;
8010520f:	be ff ff ff ff       	mov    $0xffffffff,%esi
80105214:	eb e3                	jmp    801051f9 <sys_send+0x119>
80105216:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010521d:	8d 76 00             	lea    0x0(%esi),%esi

80105220 <sys_send_multi>:
...
8010522a:	83 ec 2c             	sub    $0x2c,%esp
  if(setupp == 0) {
8010522d:	8b 1d 60 b6 10 80    	mov    0x8010b660,%ebx
80105233:	85 db                	test   %ebx,%ebx
80105235:	75 05                	jne    8010523c <sys_send_multi+0x1c>
80105237:	e8 d4 fc ff ff       	call   80104f10 <initialise.part.0>
  int *rec_pids;
  void* msg;
  ...
  int x = argint(0, &sender_pid);
8010523c:	83 ec 08             	sub    $0x8,%esp
8010523f:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105242:	50                   	push   %eax
80105243:	6a 00                	push   $0x0
80105245:	e8 e6 fd ff ff       	call   80105030 <argint>
  int y = argptr(1, (void*) &rec_pids, total * sizeof(int));
8010524a:	83 c4 0c             	add    $0xc,%esp
  int x = argint(0, &sender_pid);
8010524d:	89 c6                	mov    %eax,%esi
  int y = argptr(1, (void*) &rec_pids, total * sizeof(int));
8010524f:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105252:	6a 20                	push   $0x20
80105254:	50                   	push   %eax
80105255:	6a 01                	push   $0x1
80105257:	e8 24 fe ff ff       	call   80105080 <argptr>
  int z = argptr(2, (void*) &msg, sizeof(void*));
8010525c:	83 c4 0c             	add    $0xc,%esp
  int y = argptr(1, (void*) &rec_pids, total * sizeof(int));
8010525f:	89 c3                	mov    %eax,%ebx
  int z = argptr(2, (void*) &msg, sizeof(void*));
80105261:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105264:	6a 04                	push   $0x4
80105266:	50                   	push   %eax

  if (x < 0 || y < 0 || z < 0) {
80105267:	c1 eb 1f             	shr    $0x1f,%ebx
  int z = argptr(2, (void*) &msg, sizeof(void*));
8010526a:	6a 02                	push   $0x2
8010526c:	e8 0f fe ff ff       	call   80105080 <argptr>
  if (x < 0 || y < 0 || z < 0) {
...
80105278:	c1 e8 1f             	shr    $0x1f,%eax
8010527b:	08 d8                	or     %bl,%al
8010527d:	0f 85 f7 00 00 00    	jne    8010537a <sys_send_multi+0x15a>
80105283:	85 d2                	test   %edx,%edx
80105285:	0f 88 ef 00 00 00    	js     8010537a <sys_send_multi+0x15a>
8010528b:	31 f6                	xor    %esi,%esi
8010528d:	eb 0d                	jmp    8010529c <sys_send_multi+0x7c>
8010528f:	90                   	nop
    return -1;
  }

  for(int j = 0; j < total; j++) {
80105290:	83 c6 04             	add    $0x4,%esi
80105293:	83 fe 20             	cmp    $0x20,%esi
80105296:	0f 84 d4 00 00 00    	je     80105370 <sys_send_multi+0x150>
    if(rec_pids[j] == -1) {
8010529c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010529f:	8b 1c 30             	mov    (%eax,%esi,1),%ebx
801052a2:	83 fb ff             	cmp    $0xffffffff,%ebx
801052a5:	74 e9                	je     80105290 <sys_send_multi+0x70>
      continue;
    }
    if(rec_pids[j] != myproc()->pid) {
801052a7:	e8 c4 e6 ff ff       	call   80103970 <myproc>
801052ac:	3b 58 10             	cmp    0x10(%eax),%ebx
801052af:	74 df                	je     80105290 <sys_send_multi+0x70>
      int rec_pid = rec_pids[j];
801052b1:	8b 45 e0             	mov    -0x20(%ebp),%eax
      struct message* final;   // this is the message struct where we will add in our data 
  
      acquire(&buffer_lock);
801052b4:	83 ec 0c             	sub    $0xc,%esp
      for(int i = 0; i < NELEM(msg_buffer); i++) {
801052b7:	31 db                	xor    %ebx,%ebx
      int rec_pid = rec_pids[j];
801052b9:	8b 3c 30             	mov    (%eax,%esi,1),%edi
      acquire(&buffer_lock);
801052bc:	68 40 8f 11 80       	push   $0x80118f40
801052c1:	e8 fa f8 ff ff       	call   80104bc0 <acquire>
801052c6:	83 c4 10             	add    $0x10,%esp
801052c9:	eb 10                	jmp    801052db <sys_send_multi+0xbb>
801052cb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801052cf:	90                   	nop
      for(int i = 0; i < NELEM(msg_buffer); i++) {
801052d0:	83 c3 01             	add    $0x1,%ebx
801052d3:	81 fb 00 02 00 00    	cmp    $0x200,%ebx
801052d9:	74 b5                	je     80105290 <sys_send_multi+0x70>
        if(allocated[i] == 0) {
801052db:	8b 0c 9d 80 b6 10 80 	mov    -0x7fef4980(,%ebx,4),%ecx
801052e2:	85 c9                	test   %ecx,%ecx
801052e4:	75 ea                	jne    801052d0 <sys_send_multi+0xb0>
          allocated[i] = 1;
          release(&buffer_lock);
801052e6:	83 ec 0c             	sub    $0xc,%esp
801052e9:	83 c6 04             	add    $0x4,%esi
          allocated[i] = 1;
801052ec:	c7 04 9d 80 b6 10 80 	movl   $0x1,-0x7fef4980(,%ebx,4)
801052f3:	01 00 00 00 
          release(&buffer_lock);
801052f7:	68 40 8f 11 80       	push   $0x80118f40
801052fc:	e8 7f f9 ff ff       	call   80104c80 <release>
          final = &msg_buffer[i];
80105301:	89 da                	mov    %ebx,%edx
          
          final->bp = i;
          memmove(final->msg,msg,8);
80105303:	83 c4 0c             	add    $0xc,%esp
          final = &msg_buffer[i];
80105306:	c1 e2 04             	shl    $0x4,%edx
          memmove(final->msg,msg,8);
80105309:	6a 08                	push   $0x8
          final->bp = i;
8010530b:	89 9a 48 6f 11 80    	mov    %ebx,-0x7fee90b8(%edx)
          final = &msg_buffer[i];
80105311:	81 c2 40 6f 11 80    	add    $0x80116f40,%edx
          final->next = 0;

          acquire(&msgQueue_locks[rec_pid]);
80105317:	6b df 34             	imul   $0x34,%edi,%ebx
          memmove(final->msg,msg,8);
8010531a:	ff 75 e4             	pushl  -0x1c(%ebp)
8010531d:	52                   	push   %edx
8010531e:	89 55 d4             	mov    %edx,-0x2c(%ebp)
          acquire(&msgQueue_locks[rec_pid]);
80105321:	81 c3 80 8f 11 80    	add    $0x80118f80,%ebx
          memmove(final->msg,msg,8);
80105327:	e8 44 fa ff ff       	call   80104d70 <memmove>
          final->next = 0;
8010532c:	8b 55 d4             	mov    -0x2c(%ebp),%edx
8010532f:	c7 42 0c 00 00 00 00 	movl   $0x0,0xc(%edx)
          acquire(&msgQueue_locks[rec_pid]);
80105336:	89 1c 24             	mov    %ebx,(%esp)
80105339:	e8 82 f8 ff ff       	call   80104bc0 <acquire>
          add_in_queue(final, &QQ[rec_pid]);  // inserted in the receiver's queue
8010533e:	58                   	pop    %eax
8010533f:	5a                   	pop    %edx
80105340:	8d 04 fd 80 9c 11 80 	lea    -0x7fee6380(,%edi,8),%eax
80105347:	8b 55 d4             	mov    -0x2c(%ebp),%edx
8010534a:	50                   	push   %eax
8010534b:	52                   	push   %edx
8010534c:	e8 6f 2b 00 00       	call   80107ec0 <add_in_queue>
          unblock(rec_pid);
80105351:	89 3c 24             	mov    %edi,(%esp)
80105354:	e8 37 f2 ff ff       	call   80104590 <unblock>
          release(&msgQueue_locks[rec_pid]);
80105359:	89 1c 24             	mov    %ebx,(%esp)
8010535c:	e8 1f f9 ff ff       	call   80104c80 <release>
          break;
80105361:	83 c4 10             	add    $0x10,%esp
  for(int j = 0; j < total; j++) {
80105364:	83 fe 20             	cmp    $0x20,%esi
80105367:	0f 85 2f ff ff ff    	jne    8010529c <sys_send_multi+0x7c>
...
8010537f:	eb f1                	jmp    80105372 <sys_send_multi+0x152>
...
8010539a:	83 ec 1c             	sub    $0x1c,%esp
  if(setupp == 0) {
8010539d:	a1 60 b6 10 80       	mov    0x8010b660,%eax
801053a2:	85 c0                	test   %eax,%eax
801053a4:	75 05                	jne    801053ab <sys_recv+0x1b>
801053a6:	e8 65 fb ff ff       	call   80104f10 <initialise.part.0>
 
  initialise();
  void *msg;
  int currentPID = myproc()->pid;
801053ab:	e8 c0 e5 ff ff       	call   80103970 <myproc>
  
  int x = argptr(0, (void*)&msg, sizeof(void*));
801053b0:	83 ec 04             	sub    $0x4,%esp
  int currentPID = myproc()->pid;
801053b3:	8b 58 10             	mov    0x10(%eax),%ebx
  int x = argptr(0, (void*)&msg, sizeof(void*));
801053b6:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801053b9:	6a 04                	push   $0x4
801053bb:	50                   	push   %eax
801053bc:	6a 00                	push   $0x0
801053be:	e8 bd fc ff ff       	call   80105080 <argptr>
  if(x < 0) {
801053c3:	83 c4 10             	add    $0x10,%esp
801053c6:	85 c0                	test   %eax,%eax
801053c8:	0f 88 82 00 00 00    	js     80105450 <sys_recv+0xc0>
    return -1;
  }

  acquire(&(msgQueue_locks[currentPID]));
801053ce:	6b fb 34             	imul   $0x34,%ebx,%edi
801053d1:	83 ec 0c             	sub    $0xc,%esp
  struct message* tempMSG = remove_from_queue(&QQ[currentPID]);
801053d4:	8d 34 dd 80 9c 11 80 	lea    -0x7fee6380(,%ebx,8),%esi
  acquire(&(msgQueue_locks[currentPID]));
801053db:	81 c7 80 8f 11 80    	add    $0x80118f80,%edi
801053e1:	57                   	push   %edi
801053e2:	e8 d9 f7 ff ff       	call   80104bc0 <acquire>
  struct message* tempMSG = remove_from_queue(&QQ[currentPID]);
801053e7:	89 34 24             	mov    %esi,(%esp)
801053ea:	e8 01 2b 00 00       	call   80107ef0 <remove_from_queue>
  
  if(tempMSG == 0) {
801053ef:	83 c4 10             	add    $0x10,%esp
  struct message* tempMSG = remove_from_queue(&QQ[currentPID]);
801053f2:	89 c3                	mov    %eax,%ebx
  if(tempMSG == 0) {
801053f4:	85 c0                	test   %eax,%eax
801053f6:	74 38                	je     80105430 <sys_recv+0xa0>
...
801053fc:	e8 7f f8 ff ff       	call   80104c80 <release>
  allocated[tempMSG->bp] = 0;
  memmove(msg,tempMSG->msg,8);
80105401:	83 c4 0c             	add    $0xc,%esp
  allocated[tempMSG->bp] = 0;
80105404:	8b 43 08             	mov    0x8(%ebx),%eax
  memmove(msg,tempMSG->msg,8);
80105407:	6a 08                	push   $0x8
80105409:	53                   	push   %ebx
8010540a:	ff 75 e4             	pushl  -0x1c(%ebp)
  allocated[tempMSG->bp] = 0;
8010540d:	c7 04 85 80 b6 10 80 	movl   $0x0,-0x7fef4980(,%eax,4)
80105414:	00 00 00 00 
  memmove(msg,tempMSG->msg,8);
80105418:	e8 53 f9 ff ff       	call   80104d70 <memmove>

  return 0;
8010541d:	83 c4 10             	add    $0x10,%esp
80105420:	31 c0                	xor    %eax,%eax
}
80105422:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105425:	5b                   	pop    %ebx
80105426:	5e                   	pop    %esi
80105427:	5f                   	pop    %edi
80105428:	5d                   	pop    %ebp
...
80105434:	e8 c7 f0 ff ff       	call   80104500 <block>
    tempMSG = remove_from_queue(&QQ[currentPID]);
80105439:	89 34 24             	mov    %esi,(%esp)
8010543c:	e8 af 2a 00 00       	call   80107ef0 <remove_from_queue>
80105441:	83 c4 10             	add    $0x10,%esp
80105444:	89 c3                	mov    %eax,%ebx
80105446:	eb b0                	jmp    801053f8 <sys_recv+0x68>
80105448:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010544f:	90                   	nop
    return -1;
80105450:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105455:	eb cb                	jmp    80105422 <sys_recv+0x92>
...
801054a8:	53                   	push   %ebx
  struct proc *curproc = myproc();
801054a9:	e8 c2 e4 ff ff       	call   80103970 <myproc>
801054ae:	89 c3                	mov    %eax,%ebx
  num = curproc->tf->eax;
801054b0:	8b 40 18             	mov    0x18(%eax),%eax
801054b3:	8b 70 1c             	mov    0x1c(%eax),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801054b6:	8d 46 ff             	lea    -0x1(%esi),%eax
801054b9:	83 f8 21             	cmp    $0x21,%eax
801054bc:	77 32                	ja     801054f0 <syscall+0x50>
801054be:	8b 04 b5 20 86 10 80 	mov    -0x7fef79e0(,%esi,4),%eax
801054c5:	85 c0                	test   %eax,%eax
801054c7:	74 27                	je     801054f0 <syscall+0x50>
    curproc->tf->eax = syscalls[num]();
801054c9:	ff d0                	call   *%eax
    if (current_trace_state == TRACE_ON && num != SYS_toggle && num != SYS_print_count)  {  // incrememting the sys_call counts if trace state is ON
801054cb:	83 3d 98 bf 10 80 01 	cmpl   $0x1,0x8010bf98
    curproc->tf->eax = syscalls[num]();
801054d2:	89 c2                	mov    %eax,%edx
801054d4:	8b 43 18             	mov    0x18(%ebx),%eax
801054d7:	89 50 1c             	mov    %edx,0x1c(%eax)
    if (current_trace_state == TRACE_ON && num != SYS_toggle && num != SYS_print_count)  {  // incrememting the sys_call counts if trace state is ON
801054da:	75 33                	jne    8010550f <syscall+0x6f>
801054dc:	8d 46 e9             	lea    -0x17(%esi),%eax
801054df:	83 f8 01             	cmp    $0x1,%eax
801054e2:	76 2b                	jbe    8010550f <syscall+0x6f>
  		system_call_count[num]++;
801054e4:	83 04 b5 80 be 10 80 	addl   $0x1,-0x7fef4180(,%esi,4)
801054eb:	01 
801054ec:	eb 21                	jmp    8010550f <syscall+0x6f>
801054ee:	66 90                	xchg   %ax,%ax
    cprintf("%d %s: unknown sys call %d\n",curproc->pid, curproc->name, num);
801054f0:	8d 43 6c             	lea    0x6c(%ebx),%eax
801054f3:	56                   	push   %esi
801054f4:	50                   	push   %eax
801054f5:	ff 73 10             	pushl  0x10(%ebx)
801054f8:	68 fc 85 10 80       	push   $0x801085fc
801054fd:	e8 ae b1 ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
...
80105520:	f3 0f 1e fb          	endbr32 
  if(setupp == 0) {
80105524:	a1 60 b6 10 80       	mov    0x8010b660,%eax
80105529:	85 c0                	test   %eax,%eax
8010552b:	75 13                	jne    80105540 <initialise+0x20>
int initialise(void) {
8010552d:	55                   	push   %ebp
8010552e:	89 e5                	mov    %esp,%ebp
80105530:	83 ec 08             	sub    $0x8,%esp
80105533:	e8 d8 f9 ff ff       	call   80104f10 <initialise.part.0>
}
...
80105542:	c3                   	ret    
80105543:	66 90                	xchg   %ax,%ax
80105545:	66 90                	xchg   %ax,%ax
80105547:	66 90                	xchg   %ax,%ax
...
80105684:	68 c8 86 10 80       	push   $0x801086c8
...
8010569c:	68 c7 86 10 80       	push   $0x801086c7
...
801056b1:	68 bb 86 10 80       	push   $0x801086bb
...
801056cf:	68 ca 86 10 80       	push   $0x801086ca
801056d4:	e8 b7 ac ff ff       	call   80100390 <panic>
    panic("create: ialloc");
801056d9:	83 ec 0c             	sub    $0xc,%esp
801056dc:	68 ac 86 10 80       	push   $0x801086ac
...
80105702:	e8 29 f9 ff ff       	call   80105030 <argint>
...
80105714:	e8 57 e2 ff ff       	call   80103970 <myproc>
...
8010575d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010575f:	e8 0c e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057d1:	e8 5a f8 ff ff       	call   80105030 <argint>
...
801057e9:	e8 92 f8 ff ff       	call   80105080 <argptr>
...
80105841:	e8 ea f7 ff ff       	call   80105030 <argint>
...
80105859:	e8 22 f8 ff ff       	call   80105080 <argptr>
...
80105903:	e8 78 f7 ff ff       	call   80105080 <argptr>
...
80105943:	e8 18 fb ff ff       	call   80105460 <argstr>
...
801059ff:	e8 8c be ff ff       	call   80101890 <iput>
  end_op();
80105a04:	e8 97 d3 ff ff       	call   80102da0 <end_op>
  return 0;
...
80105a45:	e8 b6 bf ff ff       	call   80101a00 <iunlockput>
  end_op();
80105a4a:	e8 51 d3 ff ff       	call   80102da0 <end_op>
  return -1;
...
80105acd:	58                   	pop    %eax
80105ace:	5a                   	pop    %edx
80105acf:	68 c8 86 10 80       	push   $0x801086c8
...
80105ae8:	68 c7 86 10 80       	push   $0x801086c7
...
80105b42:	e8 89 f1 ff ff       	call   80104cd0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105bec:	e8 0f be ff ff       	call   80101a00 <iunlockput>
  end_op();
80105bf1:	e8 aa d1 ff ff       	call   80102da0 <end_op>
  return -1;
...
80105c25:	e9 68 ff ff ff       	jmp    80105b92 <sys_unlink+0x112>
    end_op();
80105c2a:	e8 71 d1 ff ff       	call   80102da0 <end_op>
    return -1;
...
80105c73:	e8 e8 f7 ff ff       	call   80105460 <argstr>
...
80105c8c:	e8 9f f3 ff ff       	call   80105030 <argint>
...
80105c96:	78 75                	js     80105d0d <sys_open+0xad>
  ...
  begin_op();
80105c98:	e8 93 d0 ff ff       	call   80102d30 <begin_op>
...
80105cd7:	74 23                	je     80105cfc <sys_open+0x9c>
  struct proc *curproc = myproc();
80105cd9:	e8 92 dc ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105d00:	e8 fb bc ff ff       	call   80101a00 <iunlockput>
    end_op();
80105d05:	e8 96 d0 ff ff       	call   80102da0 <end_op>
    return -1;
...
80105d50:	e8 eb ba ff ff       	call   80101840 <iunlock>
  end_op();
80105d55:	e8 46 d0 ff ff       	call   80102da0 <end_op>
...
80105df4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80105df8:	e8 a3 cf ff ff       	call   80102da0 <end_op>
    return -1;
...
80105e17:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105e1a:	e8 11 cf ff ff       	call   80102d30 <begin_op>
  if((argstr(0, &path)) < 0 ||
80105e1f:	83 ec 08             	sub    $0x8,%esp
80105e22:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105e25:	50                   	push   %eax
80105e26:	6a 00                	push   $0x0
80105e28:	e8 33 f6 ff ff       	call   80105460 <argstr>
...
80105e3d:	e8 ee f1 ff ff       	call   80105030 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105e52:	e8 d9 f1 ff ff       	call   80105030 <argint>
     argint(1, &major) < 0 ||
...
80105e82:	e8 79 bb ff ff       	call   80101a00 <iunlockput>
  end_op();
80105e87:	e8 14 cf ff ff       	call   80102da0 <end_op>
  return 0;
...
80105eb9:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105ebc:	e8 af da ff ff       	call   80103970 <myproc>
80105ec1:	89 c6                	mov    %eax,%esi
  
  begin_op();
80105ec3:	e8 68 ce ff ff       	call   80102d30 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105ec8:	83 ec 08             	sub    $0x8,%esp
80105ecb:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105ece:	50                   	push   %eax
80105ecf:	6a 00                	push   $0x0
80105ed1:	e8 8a f5 ff ff       	call   80105460 <argstr>
...
80105f11:	e8 7a b9 ff ff       	call   80101890 <iput>
  end_op();
80105f16:	e8 85 ce ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
...
80105f34:	e8 c7 ba ff ff       	call   80101a00 <iunlockput>
    end_op();
80105f39:	e8 62 ce ff ff       	call   80102da0 <end_op>
    return -1;
...
80105f4f:	90                   	nop
    end_op();
80105f50:	e8 4b ce ff ff       	call   80102da0 <end_op>
    return -1;
...
80105f79:	e8 e2 f4 ff ff       	call   80105460 <argstr>
...
80105f95:	e8 96 f0 ff ff       	call   80105030 <argint>
...
80105fba:	e8 11 ed ff ff       	call   80104cd0 <memset>
...
80105fdc:	e8 af ef ff ff       	call   80104f90 <fetchint>
...
80106000:	e8 cb ef ff ff       	call   80104fd0 <fetchstr>
...
80106075:	e8 06 f0 ff ff       	call   80105080 <argptr>
...
8010608c:	e8 5f d3 ff ff       	call   801033f0 <pipealloc>
...
8010609b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010609d:	e8 ce d8 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801060e7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801060ea:	e8 81 d8 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80106106:	75 f0                	jne    801060f8 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
80106108:	e8 63 d8 ff ff       	call   80103970 <myproc>
...
80106140:	f3 0f 1e fb          	endbr32 
  return fork();
80106144:	e9 d7 d9 ff ff       	jmp    80103b20 <fork>
...
80106157:	83 ec 08             	sub    $0x8,%esp
  exit();
8010615a:	e8 11 de ff ff       	call   80103f70 <exit>
...
80106170:	f3 0f 1e fb          	endbr32 
  return wait();
80106174:	e9 47 e0 ff ff       	jmp    801041c0 <wait>
...
80106190:	e8 9b ee ff ff       	call   80105030 <argint>
...
801061a2:	e8 89 e1 ff ff       	call   80104330 <kill>
...
801061c7:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801061ca:	e8 a1 d7 ff ff       	call   80103970 <myproc>
...
801061f1:	e8 3a ee ff ff       	call   80105030 <argint>
...
8010620a:	e8 91 d8 ff ff       	call   80103aa0 <growproc>
...
80106241:	e8 ea ed ff ff       	call   80105030 <argint>
...
80106254:	68 80 9e 11 80       	push   $0x80119e80
80106259:	e8 62 e9 ff ff       	call   80104bc0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010625e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80106261:	8b 1d c0 a6 11 80    	mov    0x8011a6c0,%ebx
  while(ticks - ticks0 < n){
...
80106273:	68 80 9e 11 80       	push   $0x80119e80
80106278:	68 c0 a6 11 80       	push   $0x8011a6c0
8010627d:	e8 7e de ff ff       	call   80104100 <sleep>
  while(ticks - ticks0 < n){
80106282:	a1 c0 a6 11 80       	mov    0x8011a6c0,%eax
...
8010628f:	73 2f                	jae    801062c0 <sys_sleep+0x90>
    if(myproc()->killed){
80106291:	e8 da d6 ff ff       	call   80103970 <myproc>
...
801062a0:	68 80 9e 11 80       	push   $0x80119e80
801062a5:	e8 d6 e9 ff ff       	call   80104c80 <release>
  }
  release(&tickslock);
  return 0;
}
...
801062c3:	68 80 9e 11 80       	push   $0x80119e80
801062c8:	e8 b3 e9 ff ff       	call   80104c80 <release>
  return 0;
...
801062e8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801062eb:	68 80 9e 11 80       	push   $0x80119e80
801062f0:	e8 cb e8 ff ff       	call   80104bc0 <acquire>
  xticks = ticks;
801062f5:	8b 1d c0 a6 11 80    	mov    0x8011a6c0,%ebx
  release(&tickslock);
801062fb:	c7 04 24 80 9e 11 80 	movl   $0x80119e80,(%esp)
80106302:	e8 79 e9 ff ff       	call   80104c80 <release>
  return xticks;
}
...
80106314:	b8 d3 07 00 00       	mov    $0x7d3,%eax
80106319:	c3                   	ret    
...
80106326:	83 3d 98 bf 10 80 01 	cmpl   $0x1,0x8010bf98
8010632d:	0f 95 c0             	setne  %al
80106330:	a3 98 bf 10 80       	mov    %eax,0x8010bf98
...
80106340:	c7 04 85 80 be 10 80 	movl   $0x0,-0x7fef4180(,%eax,4)
80106347:	00 00 00 00 
  for (int i = 0; i < TOT; i++) {
8010634b:	83 c0 01             	add    $0x1,%eax
8010634e:	83 f8 46             	cmp    $0x46,%eax
80106351:	75 ed                	jne    80106340 <sys_toggle+0x20>
  }  
  return 0;
}
...
80106368:	31 db                	xor    %ebx,%ebx
sys_print_count() {
8010636a:	83 ec 04             	sub    $0x4,%esp
8010636d:	8d 76 00             	lea    0x0(%esi),%esi
    int j = sorted_sys_calls[i];
80106370:	8b 04 9d 20 b0 10 80 	mov    -0x7fef4fe0(,%ebx,4),%eax
    if (system_call_count[j] > 0 && j != SYS_print_count && j != SYS_toggle) {
80106377:	8b 14 85 80 be 10 80 	mov    -0x7fef4180(,%eax,4),%edx
8010637e:	85 d2                	test   %edx,%edx
80106380:	7e 20                	jle    801063a2 <sys_print_count+0x42>
80106382:	8d 48 e9             	lea    -0x17(%eax),%ecx
80106385:	83 f9 01             	cmp    $0x1,%ecx
80106388:	76 18                	jbe    801063a2 <sys_print_count+0x42>
      cprintf("%s %d\n", syscall_name[j], system_call_count[j]);
8010638a:	83 ec 04             	sub    $0x4,%esp
8010638d:	52                   	push   %edx
8010638e:	ff 34 85 80 88 10 80 	pushl  -0x7fef7780(,%eax,4)
80106395:	68 0d 87 10 80       	push   $0x8010870d
8010639a:	e8 11 a3 ff ff       	call   801006b0 <cprintf>
8010639f:	83 c4 10             	add    $0x10,%esp
  for (int i = 0; i < NELEM(sorted_sys_calls); i++) {  // nelem function is defined in defs.h
801063a2:	83 c3 01             	add    $0x1,%ebx
801063a5:	83 fb 21             	cmp    $0x21,%ebx
801063a8:	75 c6                	jne    80106370 <sys_print_count+0x10>
...
801063c0:	f3 0f 1e fb          	endbr32 
  return ps();
801063c4:	e9 d7 e0 ff ff       	jmp    801044a0 <ps>
...
sys_add(void) {
801063db:	83 ec 1c             	sub    $0x1c,%esp
    int i = argint(0, &a);
801063de:	50                   	push   %eax
801063df:	6a 00                	push   $0x0
801063e1:	e8 4a ec ff ff       	call   80105030 <argint>
801063e6:	89 c3                	mov    %eax,%ebx
    int j = argint(1, &b);
801063e8:	58                   	pop    %eax
...
801063f0:	e8 3b ec ff ff       	call   80105030 <argint>

    if (i < 0 || j < 0) {
801063f5:	83 c4 10             	add    $0x10,%esp
801063f8:	85 db                	test   %ebx,%ebx
801063fa:	78 14                	js     80106410 <sys_add+0x40>
801063fc:	85 c0                	test   %eax,%eax
801063fe:	78 10                	js     80106410 <sys_add+0x40>
      return -1;
    }
    return a + b;
80106400:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106403:	03 45 f0             	add    -0x10(%ebp),%eax
}
80106406:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106409:	c9                   	leave  
8010640a:	c3                   	ret    
...
80106431:	e8 fa eb ff ff       	call   80105030 <argint>
...
80106440:	e8 eb eb ff ff       	call   80105030 <argint>

    if (i < 0 || j < 0) {
80106445:	83 c4 10             	add    $0x10,%esp
80106448:	85 db                	test   %ebx,%ebx
8010644a:	78 24                	js     80106470 <sys_exec_time+0x50>
8010644c:	85 c0                	test   %eax,%eax
8010644e:	78 20                	js     80106470 <sys_exec_time+0x50>
      return -22;
    }
    // a: pid, b: exec_time
...
80106459:	e8 12 e2 ff ff       	call   80104670 <__exec_time>
8010645e:	83 c4 10             	add    $0x10,%esp
}
80106461:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106464:	c9                   	leave  
80106465:	c3                   	ret    
80106466:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010646d:	8d 76 00             	lea    0x0(%esi),%esi
      return -22;
80106470:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
80106475:	eb ea                	jmp    80106461 <sys_exec_time+0x41>
80106477:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010647e:	66 90                	xchg   %ax,%ax

80106480 <sys_deadline>:
...
80106491:	e8 9a eb ff ff       	call   80105030 <argint>
80106496:	89 c3                	mov    %eax,%ebx
    int j = argint(1, &b);
80106498:	58                   	pop    %eax
...
801064a0:	e8 8b eb ff ff       	call   80105030 <argint>

    if (i < 0 || j < 0) {
801064a5:	83 c4 10             	add    $0x10,%esp
801064a8:	85 db                	test   %ebx,%ebx
801064aa:	78 24                	js     801064d0 <sys_deadline+0x50>
801064ac:	85 c0                	test   %eax,%eax
801064ae:	78 20                	js     801064d0 <sys_deadline+0x50>
      return -22;
    }
    // a: pid, b: deadline
    return __deadline(a, b);
801064b0:	83 ec 08             	sub    $0x8,%esp
801064b3:	ff 75 f4             	pushl  -0xc(%ebp)
801064b6:	ff 75 f0             	pushl  -0x10(%ebp)
801064b9:	e8 22 e2 ff ff       	call   801046e0 <__deadline>
801064be:	83 c4 10             	add    $0x10,%esp
}
801064c1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801064c4:	c9                   	leave  
801064c5:	c3                   	ret    
801064c6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801064cd:	8d 76 00             	lea    0x0(%esi),%esi
      return -22;
801064d0:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
801064d5:	eb ea                	jmp    801064c1 <sys_deadline+0x41>
...
801064f1:	e8 3a eb ff ff       	call   80105030 <argint>
801064f6:	89 c3                	mov    %eax,%ebx
    int j = argint(1, &b);
801064f8:	58                   	pop    %eax
...
80106500:	e8 2b eb ff ff       	call   80105030 <argint>

    if (i < 0 || j < 0) {
80106505:	83 c4 10             	add    $0x10,%esp
80106508:	85 db                	test   %ebx,%ebx
8010650a:	78 24                	js     80106530 <sys_rate+0x50>
8010650c:	85 c0                	test   %eax,%eax
8010650e:	78 20                	js     80106530 <sys_rate+0x50>
      return -22;
    }
    // a: pid, b: rate
    return __rate(a, b);
...
sys_sched_policy(void) {
8010654b:	83 ec 1c             	sub    $0x1c,%esp
    int i = argint(0, &a);
8010654e:	50                   	push   %eax
8010654f:	6a 00                	push   $0x0
80106551:	e8 da ea ff ff       	call   80105030 <argint>
80106556:	89 c3                	mov    %eax,%ebx
    int j = argint(1, &b);
80106558:	58                   	pop    %eax
80106559:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010655c:	5a                   	pop    %edx
8010655d:	50                   	push   %eax
8010655e:	6a 01                	push   $0x1
80106560:	e8 cb ea ff ff       	call   80105030 <argint>

    if (i < 0 || j < 0) {
80106565:	83 c4 10             	add    $0x10,%esp
80106568:	85 db                	test   %ebx,%ebx
8010656a:	78 24                	js     80106590 <sys_sched_policy+0x50>
8010656c:	85 c0                	test   %eax,%eax
8010656e:	78 20                	js     80106590 <sys_sched_policy+0x50>
      return -22;
    }
    // a: pid, b: policy
    return __policy(a, b);
80106570:	83 ec 08             	sub    $0x8,%esp
80106573:	ff 75 f4             	pushl  -0xc(%ebp)
80106576:	ff 75 f0             	pushl  -0x10(%ebp)
80106579:	e8 92 e2 ff ff       	call   80104810 <__policy>
8010657e:	83 c4 10             	add    $0x10,%esp
}
80106581:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106584:	c9                   	leave  
80106585:	c3                   	ret    
80106586:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010658d:	8d 76 00             	lea    0x0(%esi),%esi
      return -22;
80106590:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
80106595:	eb ea                	jmp    80106581 <sys_sched_policy+0x41>
80106597:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010659e:	66 90                	xchg   %ax,%ax

801065a0 <sys_get_pinfo>:
...
801065ad:	6a 04                	push   $0x4
801065af:	50                   	push   %eax
801065b0:	6a 00                	push   $0x0
801065b2:	e8 c9 ea ff ff       	call   80105080 <argptr>
...
801065ba:	c9                   	leave  
      return -22;
801065bb:	c1 f8 1f             	sar    $0x1f,%eax
801065be:	83 e0 ea             	and    $0xffffffea,%eax
}
801065c1:	c3                   	ret    
...
801065c3:	06                   	push   %es
  pushl %fs
801065c4:	0f a0                	push   %fs
  pushl %gs
801065c6:	0f a8                	push   %gs
  pushal
801065c8:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801065c9:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801065cd:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801065cf:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801065d1:	54                   	push   %esp
  call trap
801065d2:	e8 c9 00 00 00       	call   801066a0 <trap>
  addl $4, %esp
801065d7:	83 c4 04             	add    $0x4,%esp
...
801065da:	61                   	popa   
  popl %gs
801065db:	0f a9                	pop    %gs
  popl %fs
801065dd:	0f a1                	pop    %fs
  popl %es
801065df:	07                   	pop    %es
  popl %ds
801065e0:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801065e1:	83 c4 08             	add    $0x8,%esp
  iret
801065e4:	cf                   	iret   
801065e5:	66 90                	xchg   %ax,%ax
...
801065f4:	55                   	push   %ebp
  ...
  for(i = 0; i < 256; i++)
801065f5:	31 c0                	xor    %eax,%eax
{
801065f7:	89 e5                	mov    %esp,%ebp
801065f9:	83 ec 08             	sub    $0x8,%esp
801065fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106600:	8b 14 85 a4 b0 10 80 	mov    -0x7fef4f5c(,%eax,4),%edx
80106607:	c7 04 c5 c2 9e 11 80 	movl   $0x8e000008,-0x7fee613e(,%eax,8)
8010660e:	08 00 00 8e 
80106612:	66 89 14 c5 c0 9e 11 	mov    %dx,-0x7fee6140(,%eax,8)
80106619:	80 
8010661a:	c1 ea 10             	shr    $0x10,%edx
8010661d:	66 89 14 c5 c6 9e 11 	mov    %dx,-0x7fee613a(,%eax,8)
80106624:	80 
  for(i = 0; i < 256; i++)
...
8010662f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106632:	a1 a4 b1 10 80       	mov    0x8010b1a4,%eax
80106637:	c7 05 c2 a0 11 80 08 	movl   $0xef000008,0x8011a0c2
8010663e:	00 00 ef 
  initlock(&tickslock, "time");
80106641:	68 3d 88 10 80       	push   $0x8010883d
80106646:	68 80 9e 11 80       	push   $0x80119e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010664b:	66 a3 c0 a0 11 80    	mov    %ax,0x8011a0c0
80106651:	c1 e8 10             	shr    $0x10,%eax
80106654:	66 a3 c6 a0 11 80    	mov    %ax,0x8011a0c6
  initlock(&tickslock, "time");
8010665a:	e8 e1 e3 ff ff       	call   80104a40 <initlock>
}
...
801066a7:	57                   	push   %edi
801066a8:	56                   	push   %esi
801066a9:	53                   	push   %ebx
801066aa:	83 ec 1c             	sub    $0x1c,%esp
801066ad:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
801066b0:	8b 43 30             	mov    0x30(%ebx),%eax
801066b3:	83 f8 40             	cmp    $0x40,%eax
801066b6:	0f 84 fc 01 00 00    	je     801068b8 <trap+0x218>
    if(myproc()->killed)
      exit();
    return;
  }
...
801066c2:	77 08                	ja     801066cc <trap+0x2c>
801066c4:	3e ff 24 85 d4 89 10 	notrack jmp *-0x7fef762c(,%eax,4)
801066cb:	80 
    lapiceoi();
    break;
...
801066cc:	e8 9f d2 ff ff       	call   80103970 <myproc>
801066d1:	8b 7b 38             	mov    0x38(%ebx),%edi
801066d4:	85 c0                	test   %eax,%eax
801066d6:	0f 84 4d 02 00 00    	je     80106929 <trap+0x289>
801066dc:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801066e0:	0f 84 43 02 00 00    	je     80106929 <trap+0x289>
...
801066e6:	0f 20 d1             	mov    %cr2,%ecx
801066e9:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
801066ec:	e8 5f d2 ff ff       	call   80103950 <cpuid>
801066f1:	8b 73 30             	mov    0x30(%ebx),%esi
801066f4:	89 45 dc             	mov    %eax,-0x24(%ebp)
801066f7:	8b 43 34             	mov    0x34(%ebx),%eax
801066fa:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801066fd:	e8 6e d2 ff ff       	call   80103970 <myproc>
80106702:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106705:	e8 66 d2 ff ff       	call   80103970 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010670a:	8b 4d d8             	mov    -0x28(%ebp),%ecx
8010670d:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106710:	51                   	push   %ecx
80106711:	57                   	push   %edi
80106712:	52                   	push   %edx
80106713:	ff 75 e4             	pushl  -0x1c(%ebp)
80106716:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80106717:	8b 75 e0             	mov    -0x20(%ebp),%esi
8010671a:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010671d:	56                   	push   %esi
8010671e:	ff 70 10             	pushl  0x10(%eax)
80106721:	68 6c 89 10 80       	push   $0x8010896c
80106726:	e8 85 9f ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
8010672b:	83 c4 20             	add    $0x20,%esp
8010672e:	e8 3d d2 ff ff       	call   80103970 <myproc>
80106733:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
8010673a:	e8 31 d2 ff ff       	call   80103970 <myproc>
8010673f:	85 c0                	test   %eax,%eax
80106741:	74 1d                	je     80106760 <trap+0xc0>
80106743:	e8 28 d2 ff ff       	call   80103970 <myproc>
80106748:	8b 48 24             	mov    0x24(%eax),%ecx
8010674b:	85 c9                	test   %ecx,%ecx
8010674d:	74 11                	je     80106760 <trap+0xc0>
8010674f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80106753:	83 e0 03             	and    $0x3,%eax
80106756:	66 83 f8 03          	cmp    $0x3,%ax
8010675a:	0f 84 90 01 00 00    	je     801068f0 <trap+0x250>
...
80106760:	e8 0b d2 ff ff       	call   80103970 <myproc>
80106765:	85 c0                	test   %eax,%eax
80106767:	74 0f                	je     80106778 <trap+0xd8>
80106769:	e8 02 d2 ff ff       	call   80103970 <myproc>
8010676e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80106772:	0f 84 00 01 00 00    	je     80106878 <trap+0x1d8>
    else
    yield();
  }
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106778:	e8 f3 d1 ff ff       	call   80103970 <myproc>
8010677d:	85 c0                	test   %eax,%eax
8010677f:	74 1d                	je     8010679e <trap+0xfe>
80106781:	e8 ea d1 ff ff       	call   80103970 <myproc>
80106786:	8b 40 24             	mov    0x24(%eax),%eax
80106789:	85 c0                	test   %eax,%eax
8010678b:	74 11                	je     8010679e <trap+0xfe>
8010678d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80106791:	83 e0 03             	and    $0x3,%eax
80106794:	66 83 f8 03          	cmp    $0x3,%ax
80106798:	0f 84 43 01 00 00    	je     801068e1 <trap+0x241>
    exit();
}
...
801067a5:	c3                   	ret    
    ideintr();
801067a6:	e8 35 ba ff ff       	call   801021e0 <ideintr>
    lapiceoi();
801067ab:	e8 10 c1 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801067b0:	e8 bb d1 ff ff       	call   80103970 <myproc>
801067b5:	85 c0                	test   %eax,%eax
801067b7:	75 8a                	jne    80106743 <trap+0xa3>
801067b9:	eb a5                	jmp    80106760 <trap+0xc0>
    if(cpuid() == 0){
801067bb:	e8 90 d1 ff ff       	call   80103950 <cpuid>
801067c0:	85 c0                	test   %eax,%eax
801067c2:	75 e7                	jne    801067ab <trap+0x10b>
      acquire(&tickslock);
801067c4:	83 ec 0c             	sub    $0xc,%esp
801067c7:	68 80 9e 11 80       	push   $0x80119e80
801067cc:	e8 ef e3 ff ff       	call   80104bc0 <acquire>
      ticks++;
801067d1:	83 05 c0 a6 11 80 01 	addl   $0x1,0x8011a6c0
      if (myproc() != 0)
801067d8:	e8 93 d1 ff ff       	call   80103970 <myproc>
801067dd:	83 c4 10             	add    $0x10,%esp
801067e0:	85 c0                	test   %eax,%eax
801067e2:	74 05                	je     801067e9 <trap+0x149>
      time_ticks_update();  // updating runtimes of each process 
801067e4:	e8 17 de ff ff       	call   80104600 <time_ticks_update>
      wakeup(&ticks);
801067e9:	83 ec 0c             	sub    $0xc,%esp
801067ec:	68 c0 a6 11 80       	push   $0x8011a6c0
801067f1:	e8 ca da ff ff       	call   801042c0 <wakeup>
      release(&tickslock);
801067f6:	c7 04 24 80 9e 11 80 	movl   $0x80119e80,(%esp)
801067fd:	e8 7e e4 ff ff       	call   80104c80 <release>
80106802:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80106805:	eb a4                	jmp    801067ab <trap+0x10b>
    kbdintr();
80106807:	e8 74 bf ff ff       	call   80102780 <kbdintr>
    lapiceoi();
8010680c:	e8 af c0 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106811:	e8 5a d1 ff ff       	call   80103970 <myproc>
80106816:	85 c0                	test   %eax,%eax
80106818:	0f 85 25 ff ff ff    	jne    80106743 <trap+0xa3>
8010681e:	e9 3d ff ff ff       	jmp    80106760 <trap+0xc0>
    uartintr();
80106823:	e8 a8 02 00 00       	call   80106ad0 <uartintr>
    lapiceoi();
80106828:	e8 93 c0 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010682d:	e8 3e d1 ff ff       	call   80103970 <myproc>
80106832:	85 c0                	test   %eax,%eax
80106834:	0f 85 09 ff ff ff    	jne    80106743 <trap+0xa3>
8010683a:	e9 21 ff ff ff       	jmp    80106760 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010683f:	8b 7b 38             	mov    0x38(%ebx),%edi
80106842:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80106846:	e8 05 d1 ff ff       	call   80103950 <cpuid>
8010684b:	57                   	push   %edi
8010684c:	56                   	push   %esi
8010684d:	50                   	push   %eax
8010684e:	68 14 89 10 80       	push   $0x80108914
80106853:	e8 58 9e ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80106858:	e8 63 c0 ff ff       	call   801028c0 <lapiceoi>
    break;
8010685d:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106860:	e8 0b d1 ff ff       	call   80103970 <myproc>
80106865:	85 c0                	test   %eax,%eax
80106867:	0f 85 d6 fe ff ff    	jne    80106743 <trap+0xa3>
8010686d:	e9 ee fe ff ff       	jmp    80106760 <trap+0xc0>
80106872:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80106878:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
8010687c:	0f 85 f6 fe ff ff    	jne    80106778 <trap+0xd8>
    if((myproc()->sched_policy >= 0) 
80106882:	e8 e9 d0 ff ff       	call   80103970 <myproc>
80106887:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
8010688d:	85 d2                	test   %edx,%edx
8010688f:	78 18                	js     801068a9 <trap+0x209>
        && (myproc()->elapsed_time >= myproc()->execution_time))
80106891:	e8 da d0 ff ff       	call   80103970 <myproc>
80106896:	8b b0 90 00 00 00    	mov    0x90(%eax),%esi
8010689c:	e8 cf d0 ff ff       	call   80103970 <myproc>
801068a1:	3b b0 8c 00 00 00    	cmp    0x8c(%eax),%esi
801068a7:	7d 5e                	jge    80106907 <trap+0x267>
    yield();
801068a9:	e8 02 d8 ff ff       	call   801040b0 <yield>
801068ae:	e9 c5 fe ff ff       	jmp    80106778 <trap+0xd8>
801068b3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801068b7:	90                   	nop
    if(myproc()->killed)
801068b8:	e8 b3 d0 ff ff       	call   80103970 <myproc>
801068bd:	8b 70 24             	mov    0x24(%eax),%esi
801068c0:	85 f6                	test   %esi,%esi
801068c2:	75 3c                	jne    80106900 <trap+0x260>
    myproc()->tf = tf;
801068c4:	e8 a7 d0 ff ff       	call   80103970 <myproc>
801068c9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801068cc:	e8 cf eb ff ff       	call   801054a0 <syscall>
    if(myproc()->killed)
801068d1:	e8 9a d0 ff ff       	call   80103970 <myproc>
801068d6:	8b 58 24             	mov    0x24(%eax),%ebx
801068d9:	85 db                	test   %ebx,%ebx
801068db:	0f 84 bd fe ff ff    	je     8010679e <trap+0xfe>
}
...
801068e7:	5d                   	pop    %ebp
      exit();
801068e8:	e9 83 d6 ff ff       	jmp    80103f70 <exit>
801068ed:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
801068f0:	e8 7b d6 ff ff       	call   80103f70 <exit>
801068f5:	e9 66 fe ff ff       	jmp    80106760 <trap+0xc0>
801068fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80106900:	e8 6b d6 ff ff       	call   80103f70 <exit>
80106905:	eb bd                	jmp    801068c4 <trap+0x224>
      cprintf("The completed process has pid: %d\n", myproc()->pid);
80106907:	e8 64 d0 ff ff       	call   80103970 <myproc>
8010690c:	83 ec 08             	sub    $0x8,%esp
8010690f:	ff 70 10             	pushl  0x10(%eax)
80106912:	68 b0 89 10 80       	push   $0x801089b0
80106917:	e8 94 9d ff ff       	call   801006b0 <cprintf>
      exit();
8010691c:	e8 4f d6 ff ff       	call   80103f70 <exit>
80106921:	83 c4 10             	add    $0x10,%esp
80106924:	e9 4f fe ff ff       	jmp    80106778 <trap+0xd8>
80106929:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010692c:	e8 1f d0 ff ff       	call   80103950 <cpuid>
80106931:	83 ec 0c             	sub    $0xc,%esp
80106934:	56                   	push   %esi
80106935:	57                   	push   %edi
80106936:	50                   	push   %eax
80106937:	ff 73 30             	pushl  0x30(%ebx)
8010693a:	68 38 89 10 80       	push   $0x80108938
8010693f:	e8 6c 9d ff ff       	call   801006b0 <cprintf>
      panic("trap");
80106944:	83 c4 14             	add    $0x14,%esp
80106947:	68 0c 89 10 80       	push   $0x8010890c
8010694c:	e8 3f 9a ff ff       	call   80100390 <panic>
...
80106960:	f3 0f 1e fb          	endbr32 
  if(!uart)
80106964:	a1 9c bf 10 80       	mov    0x8010bf9c,%eax
...
80106a3b:	74 52                	je     80106a8f <uartinit+0xaf>
  uart = 1;
80106a3d:	c7 05 9c bf 10 80 01 	movl   $0x1,0x8010bf9c
80106a44:	00 00 00 
...
80106a53:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106a58:	bb 54 8a 10 80       	mov    $0x80108a54,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106a70:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80106a74:	8b 15 9c bf 10 80    	mov    0x8010bf9c,%edx
...
80106aa4:	55                   	push   %ebp
  if(!uart)
80106aa5:	8b 15 9c bf 10 80    	mov    0x8010bf9c,%edx
{
...
80106aeb:	6a 00                	push   $0x0
  jmp alltraps
80106aed:	e9 d0 fa ff ff       	jmp    801065c2 <alltraps>
...
80106af4:	6a 01                	push   $0x1
  jmp alltraps
80106af6:	e9 c7 fa ff ff       	jmp    801065c2 <alltraps>
...
80106afd:	6a 02                	push   $0x2
  jmp alltraps
80106aff:	e9 be fa ff ff       	jmp    801065c2 <alltraps>
...
80106b06:	6a 03                	push   $0x3
  jmp alltraps
80106b08:	e9 b5 fa ff ff       	jmp    801065c2 <alltraps>
...
80106b0f:	6a 04                	push   $0x4
  jmp alltraps
80106b11:	e9 ac fa ff ff       	jmp    801065c2 <alltraps>
...
80106b18:	6a 05                	push   $0x5
  jmp alltraps
80106b1a:	e9 a3 fa ff ff       	jmp    801065c2 <alltraps>
...
80106b21:	6a 06                	push   $0x6
  jmp alltraps
80106b23:	e9 9a fa ff ff       	jmp    801065c2 <alltraps>
...
80106b2a:	6a 07                	push   $0x7
  jmp alltraps
80106b2c:	e9 91 fa ff ff       	jmp    801065c2 <alltraps>
...
80106b31:	6a 08                	push   $0x8
  jmp alltraps
80106b33:	e9 8a fa ff ff       	jmp    801065c2 <alltraps>
...
80106b3a:	6a 09                	push   $0x9
  jmp alltraps
80106b3c:	e9 81 fa ff ff       	jmp    801065c2 <alltraps>
...
80106b41:	6a 0a                	push   $0xa
  jmp alltraps
80106b43:	e9 7a fa ff ff       	jmp    801065c2 <alltraps>
...
80106b48:	6a 0b                	push   $0xb
  jmp alltraps
80106b4a:	e9 73 fa ff ff       	jmp    801065c2 <alltraps>
...
80106b4f:	6a 0c                	push   $0xc
  jmp alltraps
80106b51:	e9 6c fa ff ff       	jmp    801065c2 <alltraps>
...
80106b56:	6a 0d                	push   $0xd
  jmp alltraps
80106b58:	e9 65 fa ff ff       	jmp    801065c2 <alltraps>
...
80106b5d:	6a 0e                	push   $0xe
  jmp alltraps
80106b5f:	e9 5e fa ff ff       	jmp    801065c2 <alltraps>
...
80106b66:	6a 0f                	push   $0xf
  jmp alltraps
80106b68:	e9 55 fa ff ff       	jmp    801065c2 <alltraps>
...
80106b6f:	6a 10                	push   $0x10
  jmp alltraps
80106b71:	e9 4c fa ff ff       	jmp    801065c2 <alltraps>
...
80106b76:	6a 11                	push   $0x11
  jmp alltraps
80106b78:	e9 45 fa ff ff       	jmp    801065c2 <alltraps>
...
80106b7f:	6a 12                	push   $0x12
  jmp alltraps
80106b81:	e9 3c fa ff ff       	jmp    801065c2 <alltraps>
...
80106b88:	6a 13                	push   $0x13
  jmp alltraps
80106b8a:	e9 33 fa ff ff       	jmp    801065c2 <alltraps>
...
80106b91:	6a 14                	push   $0x14
  jmp alltraps
80106b93:	e9 2a fa ff ff       	jmp    801065c2 <alltraps>
...
80106b9a:	6a 15                	push   $0x15
  jmp alltraps
80106b9c:	e9 21 fa ff ff       	jmp    801065c2 <alltraps>
...
80106ba3:	6a 16                	push   $0x16
  jmp alltraps
80106ba5:	e9 18 fa ff ff       	jmp    801065c2 <alltraps>
...
80106bac:	6a 17                	push   $0x17
  jmp alltraps
80106bae:	e9 0f fa ff ff       	jmp    801065c2 <alltraps>
...
80106bb5:	6a 18                	push   $0x18
  jmp alltraps
80106bb7:	e9 06 fa ff ff       	jmp    801065c2 <alltraps>
...
80106bbe:	6a 19                	push   $0x19
  jmp alltraps
80106bc0:	e9 fd f9 ff ff       	jmp    801065c2 <alltraps>
...
80106bc7:	6a 1a                	push   $0x1a
  jmp alltraps
80106bc9:	e9 f4 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106bd0:	6a 1b                	push   $0x1b
  jmp alltraps
80106bd2:	e9 eb f9 ff ff       	jmp    801065c2 <alltraps>
...
80106bd9:	6a 1c                	push   $0x1c
  jmp alltraps
80106bdb:	e9 e2 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106be2:	6a 1d                	push   $0x1d
  jmp alltraps
80106be4:	e9 d9 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106beb:	6a 1e                	push   $0x1e
  jmp alltraps
80106bed:	e9 d0 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106bf4:	6a 1f                	push   $0x1f
  jmp alltraps
80106bf6:	e9 c7 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106bfd:	6a 20                	push   $0x20
  jmp alltraps
80106bff:	e9 be f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c06:	6a 21                	push   $0x21
  jmp alltraps
80106c08:	e9 b5 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c0f:	6a 22                	push   $0x22
  jmp alltraps
80106c11:	e9 ac f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c18:	6a 23                	push   $0x23
  jmp alltraps
80106c1a:	e9 a3 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c21:	6a 24                	push   $0x24
  jmp alltraps
80106c23:	e9 9a f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c2a:	6a 25                	push   $0x25
  jmp alltraps
80106c2c:	e9 91 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c33:	6a 26                	push   $0x26
  jmp alltraps
80106c35:	e9 88 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c3c:	6a 27                	push   $0x27
  jmp alltraps
80106c3e:	e9 7f f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c45:	6a 28                	push   $0x28
  jmp alltraps
80106c47:	e9 76 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c4e:	6a 29                	push   $0x29
  jmp alltraps
80106c50:	e9 6d f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c57:	6a 2a                	push   $0x2a
  jmp alltraps
80106c59:	e9 64 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c60:	6a 2b                	push   $0x2b
  jmp alltraps
80106c62:	e9 5b f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c69:	6a 2c                	push   $0x2c
  jmp alltraps
80106c6b:	e9 52 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c72:	6a 2d                	push   $0x2d
  jmp alltraps
80106c74:	e9 49 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c7b:	6a 2e                	push   $0x2e
  jmp alltraps
80106c7d:	e9 40 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c84:	6a 2f                	push   $0x2f
  jmp alltraps
80106c86:	e9 37 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c8d:	6a 30                	push   $0x30
  jmp alltraps
80106c8f:	e9 2e f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c96:	6a 31                	push   $0x31
  jmp alltraps
80106c98:	e9 25 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106c9f:	6a 32                	push   $0x32
  jmp alltraps
80106ca1:	e9 1c f9 ff ff       	jmp    801065c2 <alltraps>
...
80106ca8:	6a 33                	push   $0x33
  jmp alltraps
80106caa:	e9 13 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106cb1:	6a 34                	push   $0x34
  jmp alltraps
80106cb3:	e9 0a f9 ff ff       	jmp    801065c2 <alltraps>
...
80106cba:	6a 35                	push   $0x35
  jmp alltraps
80106cbc:	e9 01 f9 ff ff       	jmp    801065c2 <alltraps>
...
80106cc3:	6a 36                	push   $0x36
  jmp alltraps
80106cc5:	e9 f8 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106ccc:	6a 37                	push   $0x37
  jmp alltraps
80106cce:	e9 ef f8 ff ff       	jmp    801065c2 <alltraps>
...
80106cd5:	6a 38                	push   $0x38
  jmp alltraps
80106cd7:	e9 e6 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106cde:	6a 39                	push   $0x39
  jmp alltraps
80106ce0:	e9 dd f8 ff ff       	jmp    801065c2 <alltraps>
...
80106ce7:	6a 3a                	push   $0x3a
  jmp alltraps
80106ce9:	e9 d4 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106cf0:	6a 3b                	push   $0x3b
  jmp alltraps
80106cf2:	e9 cb f8 ff ff       	jmp    801065c2 <alltraps>
...
80106cf9:	6a 3c                	push   $0x3c
  jmp alltraps
80106cfb:	e9 c2 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d02:	6a 3d                	push   $0x3d
  jmp alltraps
80106d04:	e9 b9 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d0b:	6a 3e                	push   $0x3e
  jmp alltraps
80106d0d:	e9 b0 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d14:	6a 3f                	push   $0x3f
  jmp alltraps
80106d16:	e9 a7 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d1d:	6a 40                	push   $0x40
  jmp alltraps
80106d1f:	e9 9e f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d26:	6a 41                	push   $0x41
  jmp alltraps
80106d28:	e9 95 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d2f:	6a 42                	push   $0x42
  jmp alltraps
80106d31:	e9 8c f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d38:	6a 43                	push   $0x43
  jmp alltraps
80106d3a:	e9 83 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d41:	6a 44                	push   $0x44
  jmp alltraps
80106d43:	e9 7a f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d4a:	6a 45                	push   $0x45
  jmp alltraps
80106d4c:	e9 71 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d53:	6a 46                	push   $0x46
  jmp alltraps
80106d55:	e9 68 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d5c:	6a 47                	push   $0x47
  jmp alltraps
80106d5e:	e9 5f f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d65:	6a 48                	push   $0x48
  jmp alltraps
80106d67:	e9 56 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d6e:	6a 49                	push   $0x49
  jmp alltraps
80106d70:	e9 4d f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d77:	6a 4a                	push   $0x4a
  jmp alltraps
80106d79:	e9 44 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d80:	6a 4b                	push   $0x4b
  jmp alltraps
80106d82:	e9 3b f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d89:	6a 4c                	push   $0x4c
  jmp alltraps
80106d8b:	e9 32 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d92:	6a 4d                	push   $0x4d
  jmp alltraps
80106d94:	e9 29 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106d9b:	6a 4e                	push   $0x4e
  jmp alltraps
80106d9d:	e9 20 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106da4:	6a 4f                	push   $0x4f
  jmp alltraps
80106da6:	e9 17 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106dad:	6a 50                	push   $0x50
  jmp alltraps
80106daf:	e9 0e f8 ff ff       	jmp    801065c2 <alltraps>
...
80106db6:	6a 51                	push   $0x51
  jmp alltraps
80106db8:	e9 05 f8 ff ff       	jmp    801065c2 <alltraps>
...
80106dbf:	6a 52                	push   $0x52
  jmp alltraps
80106dc1:	e9 fc f7 ff ff       	jmp    801065c2 <alltraps>
...
80106dc8:	6a 53                	push   $0x53
  jmp alltraps
80106dca:	e9 f3 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106dd1:	6a 54                	push   $0x54
  jmp alltraps
80106dd3:	e9 ea f7 ff ff       	jmp    801065c2 <alltraps>
...
80106dda:	6a 55                	push   $0x55
  jmp alltraps
80106ddc:	e9 e1 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106de3:	6a 56                	push   $0x56
  jmp alltraps
80106de5:	e9 d8 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106dec:	6a 57                	push   $0x57
  jmp alltraps
80106dee:	e9 cf f7 ff ff       	jmp    801065c2 <alltraps>
...
80106df5:	6a 58                	push   $0x58
  jmp alltraps
80106df7:	e9 c6 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106dfe:	6a 59                	push   $0x59
  jmp alltraps
80106e00:	e9 bd f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e07:	6a 5a                	push   $0x5a
  jmp alltraps
80106e09:	e9 b4 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e10:	6a 5b                	push   $0x5b
  jmp alltraps
80106e12:	e9 ab f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e19:	6a 5c                	push   $0x5c
  jmp alltraps
80106e1b:	e9 a2 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e22:	6a 5d                	push   $0x5d
  jmp alltraps
80106e24:	e9 99 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e2b:	6a 5e                	push   $0x5e
  jmp alltraps
80106e2d:	e9 90 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e34:	6a 5f                	push   $0x5f
  jmp alltraps
80106e36:	e9 87 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e3d:	6a 60                	push   $0x60
  jmp alltraps
80106e3f:	e9 7e f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e46:	6a 61                	push   $0x61
  jmp alltraps
80106e48:	e9 75 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e4f:	6a 62                	push   $0x62
  jmp alltraps
80106e51:	e9 6c f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e58:	6a 63                	push   $0x63
  jmp alltraps
80106e5a:	e9 63 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e61:	6a 64                	push   $0x64
  jmp alltraps
80106e63:	e9 5a f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e6a:	6a 65                	push   $0x65
  jmp alltraps
80106e6c:	e9 51 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e73:	6a 66                	push   $0x66
  jmp alltraps
80106e75:	e9 48 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e7c:	6a 67                	push   $0x67
  jmp alltraps
80106e7e:	e9 3f f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e85:	6a 68                	push   $0x68
  jmp alltraps
80106e87:	e9 36 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e8e:	6a 69                	push   $0x69
  jmp alltraps
80106e90:	e9 2d f7 ff ff       	jmp    801065c2 <alltraps>
...
80106e97:	6a 6a                	push   $0x6a
  jmp alltraps
80106e99:	e9 24 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106ea0:	6a 6b                	push   $0x6b
  jmp alltraps
80106ea2:	e9 1b f7 ff ff       	jmp    801065c2 <alltraps>
...
80106ea9:	6a 6c                	push   $0x6c
  jmp alltraps
80106eab:	e9 12 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106eb2:	6a 6d                	push   $0x6d
  jmp alltraps
80106eb4:	e9 09 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106ebb:	6a 6e                	push   $0x6e
  jmp alltraps
80106ebd:	e9 00 f7 ff ff       	jmp    801065c2 <alltraps>
...
80106ec4:	6a 6f                	push   $0x6f
  jmp alltraps
80106ec6:	e9 f7 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106ecd:	6a 70                	push   $0x70
  jmp alltraps
80106ecf:	e9 ee f6 ff ff       	jmp    801065c2 <alltraps>
...
80106ed6:	6a 71                	push   $0x71
  jmp alltraps
80106ed8:	e9 e5 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106edf:	6a 72                	push   $0x72
  jmp alltraps
80106ee1:	e9 dc f6 ff ff       	jmp    801065c2 <alltraps>
...
80106ee8:	6a 73                	push   $0x73
  jmp alltraps
80106eea:	e9 d3 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106ef1:	6a 74                	push   $0x74
  jmp alltraps
80106ef3:	e9 ca f6 ff ff       	jmp    801065c2 <alltraps>
...
80106efa:	6a 75                	push   $0x75
  jmp alltraps
80106efc:	e9 c1 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f03:	6a 76                	push   $0x76
  jmp alltraps
80106f05:	e9 b8 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f0c:	6a 77                	push   $0x77
  jmp alltraps
80106f0e:	e9 af f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f15:	6a 78                	push   $0x78
  jmp alltraps
80106f17:	e9 a6 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f1e:	6a 79                	push   $0x79
  jmp alltraps
80106f20:	e9 9d f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f27:	6a 7a                	push   $0x7a
  jmp alltraps
80106f29:	e9 94 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f30:	6a 7b                	push   $0x7b
  jmp alltraps
80106f32:	e9 8b f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f39:	6a 7c                	push   $0x7c
  jmp alltraps
80106f3b:	e9 82 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f42:	6a 7d                	push   $0x7d
  jmp alltraps
80106f44:	e9 79 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f4b:	6a 7e                	push   $0x7e
  jmp alltraps
80106f4d:	e9 70 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f54:	6a 7f                	push   $0x7f
  jmp alltraps
80106f56:	e9 67 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f5d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106f62:	e9 5b f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f69:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106f6e:	e9 4f f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f75:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106f7a:	e9 43 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f81:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106f86:	e9 37 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f8d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106f92:	e9 2b f6 ff ff       	jmp    801065c2 <alltraps>
...
80106f99:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106f9e:	e9 1f f6 ff ff       	jmp    801065c2 <alltraps>
...
80106fa5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106faa:	e9 13 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106fb1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106fb6:	e9 07 f6 ff ff       	jmp    801065c2 <alltraps>
...
80106fbd:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106fc2:	e9 fb f5 ff ff       	jmp    801065c2 <alltraps>
...
80106fc9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106fce:	e9 ef f5 ff ff       	jmp    801065c2 <alltraps>
...
80106fd5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106fda:	e9 e3 f5 ff ff       	jmp    801065c2 <alltraps>
...
80106fe1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106fe6:	e9 d7 f5 ff ff       	jmp    801065c2 <alltraps>
...
80106fed:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106ff2:	e9 cb f5 ff ff       	jmp    801065c2 <alltraps>
...
80106ff9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106ffe:	e9 bf f5 ff ff       	jmp    801065c2 <alltraps>
...
80107005:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010700a:	e9 b3 f5 ff ff       	jmp    801065c2 <alltraps>
...
80107011:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107016:	e9 a7 f5 ff ff       	jmp    801065c2 <alltraps>
...
8010701d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107022:	e9 9b f5 ff ff       	jmp    801065c2 <alltraps>
...
80107029:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010702e:	e9 8f f5 ff ff       	jmp    801065c2 <alltraps>
...
80107035:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010703a:	e9 83 f5 ff ff       	jmp    801065c2 <alltraps>
...
80107041:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107046:	e9 77 f5 ff ff       	jmp    801065c2 <alltraps>
...
8010704d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107052:	e9 6b f5 ff ff       	jmp    801065c2 <alltraps>
...
80107059:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010705e:	e9 5f f5 ff ff       	jmp    801065c2 <alltraps>
...
80107065:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010706a:	e9 53 f5 ff ff       	jmp    801065c2 <alltraps>
...
80107071:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107076:	e9 47 f5 ff ff       	jmp    801065c2 <alltraps>
...
8010707d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107082:	e9 3b f5 ff ff       	jmp    801065c2 <alltraps>
...
80107089:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010708e:	e9 2f f5 ff ff       	jmp    801065c2 <alltraps>
...
80107095:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010709a:	e9 23 f5 ff ff       	jmp    801065c2 <alltraps>
...
801070a1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801070a6:	e9 17 f5 ff ff       	jmp    801065c2 <alltraps>
...
801070ad:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801070b2:	e9 0b f5 ff ff       	jmp    801065c2 <alltraps>
...
801070b9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801070be:	e9 ff f4 ff ff       	jmp    801065c2 <alltraps>
...
801070c5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801070ca:	e9 f3 f4 ff ff       	jmp    801065c2 <alltraps>
...
801070d1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801070d6:	e9 e7 f4 ff ff       	jmp    801065c2 <alltraps>
...
801070dd:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801070e2:	e9 db f4 ff ff       	jmp    801065c2 <alltraps>
...
801070e9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801070ee:	e9 cf f4 ff ff       	jmp    801065c2 <alltraps>
...
801070f5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801070fa:	e9 c3 f4 ff ff       	jmp    801065c2 <alltraps>
...
80107101:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107106:	e9 b7 f4 ff ff       	jmp    801065c2 <alltraps>
...
8010710d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107112:	e9 ab f4 ff ff       	jmp    801065c2 <alltraps>
...
80107119:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010711e:	e9 9f f4 ff ff       	jmp    801065c2 <alltraps>
...
80107125:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010712a:	e9 93 f4 ff ff       	jmp    801065c2 <alltraps>
...
80107131:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107136:	e9 87 f4 ff ff       	jmp    801065c2 <alltraps>
...
8010713d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107142:	e9 7b f4 ff ff       	jmp    801065c2 <alltraps>
...
80107149:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010714e:	e9 6f f4 ff ff       	jmp    801065c2 <alltraps>
...
80107155:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010715a:	e9 63 f4 ff ff       	jmp    801065c2 <alltraps>
...
80107161:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107166:	e9 57 f4 ff ff       	jmp    801065c2 <alltraps>
...
8010716d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107172:	e9 4b f4 ff ff       	jmp    801065c2 <alltraps>
...
80107179:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010717e:	e9 3f f4 ff ff       	jmp    801065c2 <alltraps>
...
80107185:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010718a:	e9 33 f4 ff ff       	jmp    801065c2 <alltraps>
...
80107191:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107196:	e9 27 f4 ff ff       	jmp    801065c2 <alltraps>
...
8010719d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801071a2:	e9 1b f4 ff ff       	jmp    801065c2 <alltraps>
...
801071a9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801071ae:	e9 0f f4 ff ff       	jmp    801065c2 <alltraps>
...
801071b5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801071ba:	e9 03 f4 ff ff       	jmp    801065c2 <alltraps>
...
801071c1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801071c6:	e9 f7 f3 ff ff       	jmp    801065c2 <alltraps>
...
801071cd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801071d2:	e9 eb f3 ff ff       	jmp    801065c2 <alltraps>
...
801071d9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801071de:	e9 df f3 ff ff       	jmp    801065c2 <alltraps>
...
801071e5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801071ea:	e9 d3 f3 ff ff       	jmp    801065c2 <alltraps>
...
801071f1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801071f6:	e9 c7 f3 ff ff       	jmp    801065c2 <alltraps>
...
801071fd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107202:	e9 bb f3 ff ff       	jmp    801065c2 <alltraps>
...
80107209:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010720e:	e9 af f3 ff ff       	jmp    801065c2 <alltraps>
...
80107215:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010721a:	e9 a3 f3 ff ff       	jmp    801065c2 <alltraps>
...
80107221:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107226:	e9 97 f3 ff ff       	jmp    801065c2 <alltraps>
...
8010722d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107232:	e9 8b f3 ff ff       	jmp    801065c2 <alltraps>
...
80107239:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010723e:	e9 7f f3 ff ff       	jmp    801065c2 <alltraps>
...
80107245:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010724a:	e9 73 f3 ff ff       	jmp    801065c2 <alltraps>
...
80107251:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107256:	e9 67 f3 ff ff       	jmp    801065c2 <alltraps>
...
8010725d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107262:	e9 5b f3 ff ff       	jmp    801065c2 <alltraps>
...
80107269:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010726e:	e9 4f f3 ff ff       	jmp    801065c2 <alltraps>
...
80107275:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010727a:	e9 43 f3 ff ff       	jmp    801065c2 <alltraps>
...
80107281:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107286:	e9 37 f3 ff ff       	jmp    801065c2 <alltraps>
...
8010728d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107292:	e9 2b f3 ff ff       	jmp    801065c2 <alltraps>
...
80107299:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010729e:	e9 1f f3 ff ff       	jmp    801065c2 <alltraps>
...
801072a5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801072aa:	e9 13 f3 ff ff       	jmp    801065c2 <alltraps>
...
801072b1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801072b6:	e9 07 f3 ff ff       	jmp    801065c2 <alltraps>
...
801072bd:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801072c2:	e9 fb f2 ff ff       	jmp    801065c2 <alltraps>
...
801072c9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801072ce:	e9 ef f2 ff ff       	jmp    801065c2 <alltraps>
...
801072d5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801072da:	e9 e3 f2 ff ff       	jmp    801065c2 <alltraps>
...
801072e1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801072e6:	e9 d7 f2 ff ff       	jmp    801065c2 <alltraps>
...
801072ed:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801072f2:	e9 cb f2 ff ff       	jmp    801065c2 <alltraps>
...
801072f9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801072fe:	e9 bf f2 ff ff       	jmp    801065c2 <alltraps>
...
80107305:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010730a:	e9 b3 f2 ff ff       	jmp    801065c2 <alltraps>
...
80107311:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107316:	e9 a7 f2 ff ff       	jmp    801065c2 <alltraps>
...
8010731d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107322:	e9 9b f2 ff ff       	jmp    801065c2 <alltraps>
...
80107329:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010732e:	e9 8f f2 ff ff       	jmp    801065c2 <alltraps>
...
80107335:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010733a:	e9 83 f2 ff ff       	jmp    801065c2 <alltraps>
...
80107341:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107346:	e9 77 f2 ff ff       	jmp    801065c2 <alltraps>
...
8010734d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107352:	e9 6b f2 ff ff       	jmp    801065c2 <alltraps>
...
80107359:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010735e:	e9 5f f2 ff ff       	jmp    801065c2 <alltraps>
...
80107365:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010736a:	e9 53 f2 ff ff       	jmp    801065c2 <alltraps>
...
80107371:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107376:	e9 47 f2 ff ff       	jmp    801065c2 <alltraps>
...
8010737d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107382:	e9 3b f2 ff ff       	jmp    801065c2 <alltraps>
...
80107389:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010738e:	e9 2f f2 ff ff       	jmp    801065c2 <alltraps>
...
80107395:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010739a:	e9 23 f2 ff ff       	jmp    801065c2 <alltraps>
...
801073a1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801073a6:	e9 17 f2 ff ff       	jmp    801065c2 <alltraps>
...
801073ad:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801073b2:	e9 0b f2 ff ff       	jmp    801065c2 <alltraps>
...
801073b9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801073be:	e9 ff f1 ff ff       	jmp    801065c2 <alltraps>
...
801073c5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801073ca:	e9 f3 f1 ff ff       	jmp    801065c2 <alltraps>
...
801073d1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801073d6:	e9 e7 f1 ff ff       	jmp    801065c2 <alltraps>
...
801073dd:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801073e2:	e9 db f1 ff ff       	jmp    801065c2 <alltraps>
...
801073e9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801073ee:	e9 cf f1 ff ff       	jmp    801065c2 <alltraps>
...
801073f5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801073fa:	e9 c3 f1 ff ff       	jmp    801065c2 <alltraps>
...
80107401:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107406:	e9 b7 f1 ff ff       	jmp    801065c2 <alltraps>
...
8010740d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107412:	e9 ab f1 ff ff       	jmp    801065c2 <alltraps>
...
80107419:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010741e:	e9 9f f1 ff ff       	jmp    801065c2 <alltraps>
...
80107425:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010742a:	e9 93 f1 ff ff       	jmp    801065c2 <alltraps>
...
80107431:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107436:	e9 87 f1 ff ff       	jmp    801065c2 <alltraps>
...
8010743d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107442:	e9 7b f1 ff ff       	jmp    801065c2 <alltraps>
...
80107449:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010744e:	e9 6f f1 ff ff       	jmp    801065c2 <alltraps>
...
80107455:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010745a:	e9 63 f1 ff ff       	jmp    801065c2 <alltraps>
...
80107461:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107466:	e9 57 f1 ff ff       	jmp    801065c2 <alltraps>
...
8010746d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107472:	e9 4b f1 ff ff       	jmp    801065c2 <alltraps>
...
80107479:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010747e:	e9 3f f1 ff ff       	jmp    801065c2 <alltraps>
...
80107485:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010748a:	e9 33 f1 ff ff       	jmp    801065c2 <alltraps>
...
80107491:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107496:	e9 27 f1 ff ff       	jmp    801065c2 <alltraps>
...
8010749d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801074a2:	e9 1b f1 ff ff       	jmp    801065c2 <alltraps>
...
801074a9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801074ae:	e9 0f f1 ff ff       	jmp    801065c2 <alltraps>
...
801074b5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801074ba:	e9 03 f1 ff ff       	jmp    801065c2 <alltraps>
...
801074c1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801074c6:	e9 f7 f0 ff ff       	jmp    801065c2 <alltraps>
...
801074cd:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801074d2:	e9 eb f0 ff ff       	jmp    801065c2 <alltraps>
...
801074d9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801074de:	e9 df f0 ff ff       	jmp    801065c2 <alltraps>
...
801074e5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801074ea:	e9 d3 f0 ff ff       	jmp    801065c2 <alltraps>
...
801074f1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801074f6:	e9 c7 f0 ff ff       	jmp    801065c2 <alltraps>
...
801074fd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107502:	e9 bb f0 ff ff       	jmp    801065c2 <alltraps>
...
80107509:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010750e:	e9 af f0 ff ff       	jmp    801065c2 <alltraps>
...
80107515:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010751a:	e9 a3 f0 ff ff       	jmp    801065c2 <alltraps>
...
80107521:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107526:	e9 97 f0 ff ff       	jmp    801065c2 <alltraps>
...
8010752d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107532:	e9 8b f0 ff ff       	jmp    801065c2 <alltraps>
...
80107539:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010753e:	e9 7f f0 ff ff       	jmp    801065c2 <alltraps>
...
80107545:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010754a:	e9 73 f0 ff ff       	jmp    801065c2 <alltraps>
...
80107551:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107556:	e9 67 f0 ff ff       	jmp    801065c2 <alltraps>
...
801075ba:	e8 11 d7 ff ff       	call   80104cd0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010765d:	68 5c 8a 10 80       	push   $0x80108a5c
...
80107713:	68 86 81 10 80       	push   $0x80108186
...
80107727:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
8010772a:	e8 21 c2 ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
8010773e:	c7 80 d8 41 11 80 ff 	movl   $0xffff,-0x7feebe28(%eax)
80107745:	ff 00 00 
80107748:	c7 80 dc 41 11 80 00 	movl   $0xcf9a00,-0x7feebe24(%eax)
8010774f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107752:	c7 80 e0 41 11 80 ff 	movl   $0xffff,-0x7feebe20(%eax)
80107759:	ff 00 00 
8010775c:	c7 80 e4 41 11 80 00 	movl   $0xcf9200,-0x7feebe1c(%eax)
80107763:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107766:	c7 80 e8 41 11 80 ff 	movl   $0xffff,-0x7feebe18(%eax)
8010776d:	ff 00 00 
80107770:	c7 80 ec 41 11 80 00 	movl   $0xcffa00,-0x7feebe14(%eax)
80107777:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010777a:	c7 80 f0 41 11 80 ff 	movl   $0xffff,-0x7feebe10(%eax)
80107781:	ff 00 00 
80107784:	c7 80 f4 41 11 80 00 	movl   $0xcff200,-0x7feebe0c(%eax)
8010778b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010778e:	05 d0 41 11 80       	add    $0x801141d0,%eax
  pd[1] = (uint)p;
...
801077b4:	a1 c4 a6 11 80       	mov    0x8011a6c4,%eax
...
801077f8:	0f 84 c2 00 00 00    	je     801078c0 <switchuvm+0xf0>
  pushcli();
801077fe:	e8 bd d2 ff ff       	call   80104ac0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107803:	e8 d8 c0 ff ff       	call   801038e0 <mycpu>
80107808:	89 c3                	mov    %eax,%ebx
8010780a:	e8 d1 c0 ff ff       	call   801038e0 <mycpu>
8010780f:	89 c7                	mov    %eax,%edi
80107811:	e8 ca c0 ff ff       	call   801038e0 <mycpu>
80107816:	83 c7 08             	add    $0x8,%edi
80107819:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010781c:	e8 bf c0 ff ff       	call   801038e0 <mycpu>
...
80107913:	e8 b8 d3 ff ff       	call   80104cd0 <memset>
...
80107946:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107947:	e9 24 d4 ff ff       	jmp    80104d70 <memmove>
    panic("inituvm: more than a page");
8010794c:	83 ec 0c             	sub    $0xc,%esp
8010794f:	68 a1 8a 10 80       	push   $0x80108aa1
...
80107a7b:	e8 50 d2 ff ff       	call   80104cd0 <memset>
...
80107ab9:	68 d9 8a 10 80       	push   $0x80108ad9
...
80107b1b:	68 f1 8a 10 80       	push   $0x80108af1
...
80107bfc:	68 0d 8b 10 80       	push   $0x80108b0d
...
80107c27:	bb c0 b4 10 80       	mov    $0x8010b4c0,%ebx
  memset(pgdir, 0, PGSIZE);
80107c2c:	68 00 10 00 00       	push   $0x1000
80107c31:	6a 00                	push   $0x0
80107c33:	50                   	push   %eax
80107c34:	e8 97 d0 ff ff       	call   80104cd0 <memset>
...
80107c5e:	81 fb 00 b5 10 80    	cmp    $0x8010b500,%ebx
...
80107c9f:	a3 c4 a6 11 80       	mov    %eax,0x8011a6c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107cd3:	68 1e 8b 10 80       	push   $0x80108b1e
...
80107d20:	e8 4b d0 ff ff       	call   80104d70 <memmove>
...
80107db9:	68 42 8b 10 80       	push   $0x80108b42
80107dbe:	e8 cd 85 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107dc3:	83 ec 0c             	sub    $0xc,%esp
80107dc6:	68 28 8b 10 80       	push   $0x80108b28
...
80107e4e:	e8 1d cf ff ff       	call   80104d70 <memmove>
    len -= n;
    buf += n;
...
80107ea7:	8b 45 08             	mov    0x8(%ebp),%eax
  Q->front = NULL;
80107eaa:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  Q->last = NULL;
80107eb0:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
80107eb7:	5d                   	pop    %ebp
80107eb8:	c3                   	ret    
80107eb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80107ec0 <add_in_queue>:

void add_in_queue(struct message *n, struct msgQueue *Q) {
80107ec0:	f3 0f 1e fb          	endbr32 
80107ec4:	55                   	push   %ebp
80107ec5:	89 e5                	mov    %esp,%ebp
80107ec7:	8b 45 08             	mov    0x8(%ebp),%eax
80107eca:	8b 55 0c             	mov    0xc(%ebp),%edx
  n->next = NULL;
80107ecd:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)

  if (Q->last == NULL) {
80107ed4:	8b 4a 04             	mov    0x4(%edx),%ecx
80107ed7:	85 c9                	test   %ecx,%ecx
80107ed9:	74 0d                	je     80107ee8 <add_in_queue+0x28>
    Q->front = n;
    Q->last = n;
  } else {
    Q->last->next = n;
80107edb:	89 41 0c             	mov    %eax,0xc(%ecx)
    Q->last = n;
80107ede:	89 42 04             	mov    %eax,0x4(%edx)
  }
}
80107ee1:	5d                   	pop    %ebp
80107ee2:	c3                   	ret    
80107ee3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107ee7:	90                   	nop
    Q->front = n;
80107ee8:	89 02                	mov    %eax,(%edx)
    Q->last = n;
80107eea:	89 42 04             	mov    %eax,0x4(%edx)
}
80107eed:	5d                   	pop    %ebp
80107eee:	c3                   	ret    
80107eef:	90                   	nop

80107ef0 <remove_from_queue>:
...
80107ef7:	8b 55 08             	mov    0x8(%ebp),%edx
  if (Q->front == NULL) {
80107efa:	8b 02                	mov    (%edx),%eax
80107efc:	85 c0                	test   %eax,%eax
80107efe:	74 09                	je     80107f09 <remove_from_queue+0x19>
    return NULL;
  }

  struct message *m = Q->front;
  Q->front = Q->front->next;
80107f00:	8b 48 0c             	mov    0xc(%eax),%ecx
80107f03:	89 0a                	mov    %ecx,(%edx)

  if (Q->front == NULL) {
80107f05:	85 c9                	test   %ecx,%ecx
80107f07:	74 07                	je     80107f10 <remove_from_queue+0x20>
    Q->last = NULL;
  }
...
80107f0f:	90                   	nop
    Q->last = NULL;
80107f10:	c7 42 04 00 00 00 00 	movl   $0x0,0x4(%edx)
}
80107f17:	5d                   	pop    %ebp
80107f18:	c3                   	ret    
