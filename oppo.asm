...
{   
  ...
  17:	c7 45 d0 07 00 00 00 	movl   $0x7,-0x30(%ebp)
  1e:	c7 45 d4 18 00 00 00 	movl   $0x18,-0x2c(%ebp)
  25:	c7 45 d8 0f 00 00 00 	movl   $0xf,-0x28(%ebp)
    int exectime[3] = {5, 6, 4};
  2c:	c7 45 dc 05 00 00 00 	movl   $0x5,-0x24(%ebp)
  33:	c7 45 e0 06 00 00 00 	movl   $0x6,-0x20(%ebp)
  3a:	c7 45 e4 04 00 00 00 	movl   $0x4,-0x1c(%ebp)

    int parent_pid = getpid();
  41:	e8 5d 03 00 00       	call   3a3 <getpid>
  ...
  5a:	6a 0b                	push   $0xb
  5c:	53                   	push   %ebx
  5d:	e8 a9 03 00 00       	call   40b <deadline>
  ...
  67:	31 f6                	xor    %esi,%esi
    exec_time(parent_pid, 4);
  69:	e8 95 03 00 00       	call   403 <exec_time>
    sched_policy(parent_pid, 0);
  6e:	58                   	pop    %eax
  6f:	5a                   	pop    %edx
  70:	6a 00                	push   $0x0
  72:	53                   	push   %ebx
  73:	e8 a3 03 00 00       	call   41b <sched_policy>
  78:	83 c4 10             	add    $0x10,%esp
    {
        int cid = fork();
  7b:	e8 9b 02 00 00       	call   31b <fork>
  80:	89 c3                	mov    %eax,%ebx
        if (cid != 0)
  82:	85 c0                	test   %eax,%eax
  84:	74 30                	je     b6 <main+0xb6>
        {
            // Set the scheduling policy to EDF
            deadline(cid, Deadline[i]);
  86:	83 ec 08             	sub    $0x8,%esp
  89:	ff 74 b5 d0          	pushl  -0x30(%ebp,%esi,4)
  8d:	50                   	push   %eax
  8e:	e8 78 03 00 00       	call   40b <deadline>
            exec_time(cid, exectime[i]);
  93:	58                   	pop    %eax
  94:	5a                   	pop    %edx
  95:	ff 74 b5 dc          	pushl  -0x24(%ebp,%esi,4)
  99:	53                   	push   %ebx
    for(int i = 0; i < num_procs; i++)
  9a:	83 c6 01             	add    $0x1,%esi
            exec_time(cid, exectime[i]);
  9d:	e8 61 03 00 00       	call   403 <exec_time>
            sched_policy(cid, 0);
  a2:	59                   	pop    %ecx
  a3:	58                   	pop    %eax
  a4:	6a 00                	push   $0x0
  a6:	53                   	push   %ebx
  a7:	e8 6f 03 00 00       	call   41b <sched_policy>
    for(int i = 0; i < num_procs; i++)
  ac:	83 c4 10             	add    $0x10,%esp
  af:	83 fe 03             	cmp    $0x3,%esi
  b2:	75 c7                	jne    7b <main+0x7b>
...
printf(int fd, const char *fmt, ...)
{
 ...
 589:	e8 b5 fd ff ff       	call   343 <write>
        putc(fd, c);
      } else {
 ...
 611:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 614:	e8 2a fd ff ff       	call   343 <write>
        ap++;
 ...
 68b:	57                   	push   %edi
 68c:	53                   	push   %ebx
 68d:	e8 b1 fc ff ff       	call   343 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7ab:	e8 fb fb ff ff       	call   3ab <sbrk>
  if(p == (char*)-1)
